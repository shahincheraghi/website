            ...
            <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                ...
                <ul class="fontFooterCustom  list-unstyled pt-3 ul-contact-info-footer">
                    ...
                    <li style="width: 100%  ;"><p class="fontFooterCustom dirRtl">
                            ...
                            &nbsp;
                            تلفن :
                            &nbsp;<a class="textTagAInFooter"
                                     href="tel:{{(isset($footer->phone))?$footer->phone:''}}">{{(isset($footer->phone))?$footer->phone:''}}</a>
                            &nbsp;
                        </p>
                    </li>
                    <li style="width: 100%  ;"><p class="fontFooterCustom dirRtl">
                            ...
                            &nbsp;
                            &nbsp;&nbsp;<a class="textTagAInFooter"
                                           href="mailto:{{(isset($footer->email))?$footer->email:''}}">{{(isset($footer->email))?$footer->email:''}}</a>
                        </p>
                    </li>
                </ul>
                <ul class="list-unstyled social-icon foot-social-icon mb-0 mt-4 mr-0 pr-0">
                    @if(($footer->whatsapp))
                        <li class="list-inline-item"><a href="{{(isset($footer->whatsapp))?$footer->whatsapp:''}}"
                                                        class="rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     viewBox="0,0,256,256" width="19px" height="19px" fill-rule="nonzero">
                    ...
                    @endif
                    @if(($footer->telegram))
                        <li class="list-inline-item"><a href="{{(isset($footer->telegram))?$footer->telegram:''}}"
                                                        class="rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     viewBox="0,0,256,256" width="19px" height="19px" fill-rule="nonzero">
                                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1"
                    ...
                    @endif
                    @if(($footer->instagram))
                        <li class="list-inline-item"><a href="{{(isset($footer->instagram))?$footer->instagram:''}}"
                                                        class="rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     viewBox="0,0,256,256" width="19px" height="19px" fill-rule="nonzero">
                                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1"
                    ...
                    @endif
                    @if(($footer->aparat))
                        <li class="list-inline-item"><a href="{{(isset($footer->aparat))?$footer->aparat:''}}"
                                                        class="rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     viewBox="0,0,256,256" width="19px" height="19px" fill-rule="nonzero">
                                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1"
                    ...
                    @if(($footer->linkedin))
                        <li class="list-inline-item"><a href="{{(isset($footer->linkedin))?$footer->linkedin:''}}"
                                                        class="rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     viewBox="0,0,256,256" width="19px" height="19px" fill-rule="nonzero">
                                    <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1"
                ...
                <ul class="list-unstyled footer-list mt-4">
                    @if(isset($menusFooter1))
                        @foreach($menusFooter1 as $item)
                            ...
                            <li><a href="{{$item->link}}" class="text-foot font-14"><i
                ...
                <ul class="list-unstyled footer-list mt-4">
                    @if(isset($menusFooter2))
                        @foreach($menusFooter2 as $item)
                            ...
                            <li>
                                <a href="{{$item->link}}" class="text-foot font-14"><i
                                        class="uil uil-angle-left-b me-1"></i> خدمات سایت
                                </a>
                            </li>
                        @endforeach
                    @endif
            ...
            <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                ...
                <form id="subscribeForm">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="EnamadPlaceBox mt-3">
                            <a referrerpolicy="origin" target="_blank"
                               href="https://trustseal.enamad.ir/?id=315117&amp;Code=Q7Dko5ZeMSNPRQCRXbs2"><img
                                    referrerpolicy="origin"
                                    src="https://Trustseal.eNamad.ir/logo.aspx?id=315117&amp;Code=Q7Dko5ZeMSNPRQCRXbs2"
                                    alt="" style="cursor:pointer" id="Q7Dko5ZeMSNPRQCRXbs2"></a>
                        </div>
                    </div>
                </form>
            </div><!--end col-->
