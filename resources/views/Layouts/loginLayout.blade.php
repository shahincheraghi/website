...
<head>
    ...
    <meta name="description" content=" پنل مدیرت{{(isset($settings['titleSite']))?$settings['titleSite']:''}}  @yield('title')">
    <meta name="keywords" content=" پنل مدیرت{{(isset($settings['titleSite']))?$settings['titleSite']:''}}  @yield('title')">
...
<!-- BEGIN: Body-->
<body class="vertical-layout vertical-menu-modern light-layout 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-layout="dark-layout">
