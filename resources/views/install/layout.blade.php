...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: url('/Front/fonts/IRANSansWeb.eot');
            src: url('/Front/fonts/IRANSansWeb.eot?#iefix') format('embedded-opentype'), /* IE6-8 */ url('/Front/fonts/IRANSansWeb.woff2') format('woff2'), /* FF39+,Chrome36+, Opera24+*/ url('/Front/fonts/IRANSansWeb.woff') format('woff'), /* FF3.6+, IE9, Chrome6+, Saf5.1+*/ url('/Front/fonts/IRANSansWeb.ttf') format('truetype');
        }
        ...
        .custom-select-black {
            ...
            background: transparent url('../../public/modules/admin/images/arrow-black.png') no-repeat left 8px center;
