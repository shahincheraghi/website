...
@section('content')
    ...
    <form method="POST" action="{{ route('install.configuration.post') }}" class="form-horizontal">
        ...
        <div class="box">
            <p>لطفا جزئیات اتصال دیتابیس خود را وارد کنید.</p>

            <div class="configure-form">
                <div class="form-group {{ $errors->has('db.host') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="host">هاست <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="text" name="db[host]" value="{{ old('db.host', '127.0.0.1') }}" required id="host" class="form-control" autofocus>
                        {!! $errors->first('db.host', '<span class="help-block">:message</span>') !!}
                    </div>
                </div>

                <div class="form-group {{ $errors->has('db.port') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="port">پورت <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="text" name="db[port]" value="{{ old('db.port', '3306') }}" required id="port" class="form-control">
                ...
                <div class="form-group {{ $errors->has('db.username') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="db-username">نام کاربری دیتابیس <span>*</span></label>
                    <div class="col-sm-9">
                        <input type="text" name="db[username]" required value="{{ old('db.username') }}" id="db-username" class="form-control">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="db-password">کلمه عبور دیتابیس </label>
                ...
                <div class="form-group {{ $errors->has('db.database') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="database">نام دیتابیس  <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="text" name="db[database]" required value="{{ old('db.database') }}" id="database" class="form-control">
        ...
        <div class="box">
            <p>لطفاً یک نام کاربری و رمز عبور را برای مدیر وارد کنید.
            </p>

            <div class="configure-form">
                <div class="form-group {{ $errors->has('admin.first_name') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="admin-first-name">نام<span>*</span></label>

                    <div class="col-sm-9">
                        <input type="text" name="admin[first_name]" value="{{ old('admin.first_name') }}" id="admin-first-name" class="form-control" required>
                ...
                <div class="form-group {{ $errors->has('admin.last_name') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="admin-last-name">نام خانودگی <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="text" name="admin[last_name]" value="{{ old('admin.last_name') }}" id="admin-last-name" class="form-control" required>
                ...
                <div class="form-group {{ $errors->has('admin.email') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="admin-email">ایمیل <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="email" name="admin[email]" value="{{ old('admin.email') }}" id="admin-email" class="form-control" required>
                ...
                <div class="form-group {{ $errors->has('admin.password') ? 'has-error': '' }}">
                    <label class="control-label col-sm-3" for="admin-password">کلمه عبور <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="password" required name="admin[password]" id="admin-password" class="form-control">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="admin-confirm-password">تایید کلمه عبور <span>*</span></label>

                    <div class="col-sm-9">
                        <input type="password" required name="admin[password_confirmation]" id="admin-confirm-password" class="form-control">
                    </div>
                </div>
            </div>
        </div>
...
{{--        </div>--}}
        ...
        <div class="content-buttons clearfix">
            <button type="submit" class="btn btn-primary pull-right install-button">نصب</button>
        </div>
    </form>
@endsection
