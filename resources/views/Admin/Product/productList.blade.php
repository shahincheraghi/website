                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.productList')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            @foreach($data['products'] as $value)
                                <tr>
                                    ...
                                    <td>
                                                ...
                                                <a href="{{route('Admin.products.edit',$value->id)}}" type="button"
                                           class="btn btn-icon  rounded-circle btn-warning mr-1 mb-1 waves-effect waves-light"><i
                                                class="feather icon-edit"></i></a>
                                        <a onclick="deleteRecord('{{route('Admin.products.delete',$value->id)}}')"
                                           type="button"
