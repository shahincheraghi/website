                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">{{trans('langPanel.blogEdit')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class=" col-md-10 col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.blogEdit')}}</h4>
                                </div>

                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST"
                                              action="{{route('Admin.blogs.update',$data['Blog']->id)}}"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="title" class="form-control"
                                                                   ...
                                                                   required value="{{$data['Blog']->title}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="author_name" class="form-control"
                                                                   ...
                                                                   required value="{{$data['Blog']->author_name}}">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                        <input class="form-control " type="text" id="keywords" data-role="tagsinput" value="{{$data['Blog']->keywords}}" name="keywords">
                                                        </div>
                                                    </div>
                                       ...
                                       <textarea type="text" name="short_description" class="form-control"
                                                 ...
                                                 required>{{$data['Blog']->short_description}}</textarea>
                                                    </div>
...
<script src="{{ asset('Admin/assets/js/bootstrap-tagsinput.js')}}"></script>
    <script>
            @isset($data['Blog']->category_id )
        var val ={!! $data['Blog']->category_id !!};
