...
@section('title')
    |{{trans('langPanel.insert_service')}}
@endsection
@section('css')
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.insert_service')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.insert_service')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{route('Admin.services.store')}}"
                                                        ...
                                                        <div class="controls">
                                                            <fieldset>
                                                                <div class="vs-checkbox-con vs-checkbox-primary">
                                                                    <input type="checkbox"
                                                                           id="checkbox1" value="1" name="special_service">
