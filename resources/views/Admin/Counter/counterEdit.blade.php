                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.counterEdit')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class=" col-md-10 col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.counterEdit')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST"
                                              action="{{route('Admin.counters.update',$data['Counter']->id)}}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="title" class="form-control"
                                                                   ...
                                                                   required value="{{$data['Counter']->title}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="subTitle" class="form-control"
                                                                   ...
                                                                   placeholder="{{trans('langPanel.inputSubTitle')}}"
                                                                   required value="{{$data['Counter']->subTitle}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="number" name="number" class="form-control"
                                                                   ...
                                                                   required value="{{$data['Counter']->number}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               value="{{$data['Counter']->icon}}" name="icon"
