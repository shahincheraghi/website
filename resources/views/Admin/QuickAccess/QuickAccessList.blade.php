...
@section('title')
    | {{trans('langPanel.QuickAccessList')}}
@endsection
@section('css')
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.listQuickAccess')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="row justify-content-end pr-5">
                        <div>
                            ...
                            <a class="btn btn-outline-primary" href="{{route('Admin.QuickAccess.create')}}">
                                جدید
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table data-list-view">
                            ...
                            @forelse($QuickAccess as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('Admin.QuickAccess.edit',$item->id)}}"
                                           type="button"
                                           class="btn btn-icon  rounded-circle btn-warning mr-1 mb-1 waves-effect waves-light"><i
                                                class="feather icon-edit"></i></a>
                                        <a onclick="deleteRecord('{{route('Admin.QuickAccess.destroy',$item->id)}}')"
                                           type="button"
