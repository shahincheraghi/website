                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="status" name="status">
                                                        <option value="">{{trans('langPanel.All')}}</option>
                                                        <option value="0">{{trans('langPanel.new')}}</option>
                                                        <option value="1">{{trans('langPanel.confirmed')}}</option>
                                                        <option value="2">{{trans('langPanel.post')}}</option>
                                                        <option value="3">{{trans('langPanel.complete')}}</option>
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="user" name="user">
                                                        ...
                                                        <option value="{{$users->id}}">{{$users->name}}-{{$users->family}}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control Datepick "  placeholder="{{trans('langPanel.startDate')}}" name="dateStart" value=""  />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                 <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control Datepick "  placeholder="{{trans('langPanel.endDate')}}" name="dateEnd" value=""  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-lg-4">
                                                 <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control  "  placeholder="{{trans('langPanel.mobile')}}" name="mobile" value=""  />
                                                    </div>
                                                </div>
                                            </div>

                                        </div>
                                        <button type="submit" class="btn btn-primary">{{trans('langPanel.filters')}}</button>
                                    </form>
                                </div>
                            </div>
                        </div>
