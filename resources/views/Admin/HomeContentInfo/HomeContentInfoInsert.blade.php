...
@section('title')
    |{{trans('langPanel.insertHomeContentInfo')}}
@endsection
@section('css')
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.insertHomeContentInfo')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.insertHomeContentInfo')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{route('Admin.HomeContentInfo.store')}}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <fieldset class="form-group">
                                                        <label for="subTitle">{{trans('langPanel.subTitle')}}</label>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <select name="keyHomeContent" class="form-control" id="keyHomeContent">
                                                            <option value="TextWithBackground">باکس متن با پشت زمینه</option>
                                                            <option value="HomeBox2">باکس ۳ قسمته</option>
                                                            <option value="HomeBox3">باکس متنی باعکس</option>
                                                            <option value="HomeBox4">اسلایدر لوگو</option>
                                                            <option value="CompetitiveAdvantage"> مزیت رقابتی</option>
                                                            <option value="QuickAccess">دسترسی سریع</option>
                                                            <option value="BusinessProcess">فرآیند کار</option>
                                                            <option value="CustomersComment">نظرات مشتریان</option>
                                                            <option value="BigPicInLapTop">عکس با فریم لپتاپ</option>
                                                            <option value="faq">سوالات متداول</option>
                                                            <option value="counter">شمارنده</option>
                                                            <option value="blog">دانستنی ها</option>
