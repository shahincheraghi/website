...
@section('title')
    |{{trans('langPanel.insertBusinessProcess')}}
@endsection
@section('css')
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.insertBusinessProcess')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.insertBusinessProcess')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" action="{{route('Admin.BusinessProcess.store')}}"
                                            ...
                                            <div class="row">
                                                <div hidden class="col-md-12 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input required type="text"  value="7" hidden class="form-control" name="type"
                                                               id="type" >
                                                    </fieldset>
                                                </div>
