...
@section('title')
    | {{trans('langPanel.list_of_skills')}}
@endsection
@section('css')
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{trans('langPanel.skills')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.list_of_skills')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="data-list-view" class="data-list-view-header">
                    ...
                    <div class="row justify-content-end pr-5">
                        <div>
                            <a class="btn btn-outline-primary" href="{{route('Admin.skills.create')}}">
                                جدید
                            </a>
                        </div>
                    </div>
                            ...
                            @forelse($skills as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('Admin.skills.edit',$item->id)}}" type="button"
                                           class="btn btn-icon  rounded-circle btn-warning mr-1 mb-1 waves-effect waves-light"><i
                                                class="feather icon-edit"></i></a>
                                        <a onclick="deleteRecord('{{route('Admin.skills.delete',$item->id)}}')"
                                           type="button"
