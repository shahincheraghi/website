                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.team_editing')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.team_editing')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal"
                                              action="{{route('Admin.teams.update',$data['Team']->id)}}"
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               value="{{$data['Team']->fullname}}" name="fullname"
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="form-group">
                                                        <label
                                                            ...
                                                            (36*36)
                                                            <img src="/{{$data['Team']->image}}" width="36px"
                                                                 height="36px">
                                                        </label>
                                                ...
                                                @foreach($data['socials'] as $item)
                                                    <div class="row">
                                                        <div class="col-md-3 ">
                                                            <fieldset class="form-group">
                                                                <label
                                                                    for="basicInput">{{trans('langPanel.title')}}</label>
                                                                <input type="text" class="form-control" name="title[]"
                                                                       value="{{$item->title}}" id="title" required>
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-3 col-12">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="link[]"
                                                                       id="link" required value="{{$item->link}}">
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-3 col-12">
                                                            <fieldset class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="{{$item->class_font}}">
                                                            </fieldset>
                                                        </div>
                                                        <div class="col-md-3 col-12 pt-2">
                                                            <button onclick="parentsDelete(this)"
                                                                    class="btn btn-warning btn-sm pr-1 pl-1"
