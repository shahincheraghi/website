                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">{{trans('langPanel.HomeBox1')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a
                                            href="#">{{trans('langPanel.editHomeBox1')}}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">{{trans('langPanel.editHomeBox1')}}</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">

                                        <form class="form-horizontal"
                                              action="{{route('Admin.HomeBox1.update',$data['HomeBox1']->id)}}"
                                                ...
                                                <div class="row">
                                                    <div hidden class="col-md-12 col-12">
                                                        <fieldset class="form-group">
                                                            ...
                                                            <input required type="text"  value="{{$data['HomeBox1']->type}}" hidden class="form-control" name="type"
                                                                   id="type" >
                                                        </fieldset>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    ...
                                                    <img height="100px" width="150x" src="/File/HomeContent/{{$data['HomeBox1']->path}}" alt="">
                                                    <fieldset class="form-group">
                                                        <label
                                                ...
                                                <div class="col-12">
                                                    <fieldset class="form-label-group">
                                                        <textarea class="form-control" id="description"
                                                                  name="description"
                                                                  rows="3">{{$data['HomeBox1']->description}}</textarea>
                                                        <label
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <select name="status" class="form-control" id="basicInput">
                                                            <option value="1" {{ $data['HomeBox1']->status  == 1 ? 'selected' : '' }}>فعال</option>
                                                            <option value="3" {{ $data['HomeBox1']->status  == 3 ? 'selected' : '' }}>غیر فعال</option>
                                                        </select>
                                                    </fieldset>
                                                </div>
