...
!function (e) {
    ...
    !function (e) {
        ...
        const s = function (e, t = !1) {
            ...
            }))).replace(/\s/g, "-").replace(/^-+/g, ""), h = e => e.replace(/-([a-z])/g, (e, t) => t.toUpperCase()),
            g = function () {
                let e, t = 0;
                return function (r) {
            ...
            w = function (e, t = "", r = {}) {
                ...
                const {events: n} = r, i = a(r, ["events"]), l = document.createElement(e), s = {
                    ...
                    }, node: e => l.appendChild(e), array: e => {
                ...
                for (const e in i) if (i.hasOwnProperty(e)) {
                    const t = m(e), r = Array.isArray(i[e]) ? E(i[e].join(" ").split(" ")).join(" ") : i[e];
                    if ("boolean" == typeof r) {
                        if (!0 === r) {
                ...
                if (t) {
                    ...
                    for (let t = 0; t < e.length; t++) {
                        const o = v(e[t]), n = e[t].getElementsByTagName("option"),
            ...
            }, E = e => e.filter((e, t, r) => r.indexOf(e) === t), N = (e, t) => {
                const r = t.indexOf(e);
                r > -1 && t.splice(r, 1)
            }, S = (e, t) => {
                const r = jQuery;
                ...
                return r
            }, R = (e, t, r) => t.split(" ").forEach(t => e.addEventListener(t, r, !1)), I = (e, t) => {
                const r = t.replace(".", "");
            ...
            }, P = e => e.replace(/\s/g, "-").replace(/[^a-zA-Z0-9[\]_-]/g, ""), M = e => e.replace(/[^0-9]/g, ""),
            ...
            }, U = /^col-(xs|sm|md|lg)-([^\s]+)/, V = e => e.split(" ").filter(e => U.test(e) || e.startsWith("row-"));
        ...
        class a {
            ...
            static getClass(e, t) {
                const r = t ? e + "." + t : e, o = a.classRegister[r] || a.classRegister[e];
            ...
            static mi18n(e, t) {
                ...
                const n = this.camelCase(e), l = "object" == typeof o ? o[n] || o[e] : o;
                if (l) return l;
                let a = r.mi18n;
            ...
            build() {
                const e = this.config, {label: t, type: r} = e, n = l(e, ["label", "type"]);
 ...
 */
        e.exports = function (e) {
            ...
            function c(e, t) {
                if (null != e) if ("object" !== (void 0 === e ? "undefined" : o(e)) && (e = [e]), a(e)) for (var r = 0, n = e.length; r < n; r++) t.call(null, e[r], r, e); else for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && t.call(null, e[i], i, e)
            }
            ...
            var o = r(0), n = r(14), i = r(16), l = r(17), a = r(18), s = r(4),
            ...
            e.exports = function (e) {
                return new Promise((function (t, c) {
                    ...
                    var p = new XMLHttpRequest, m = "onreadystatechange", b = !1;
                    if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in p || a(e.url) || (p = new window.XDomainRequest, m = "onload", b = !0, p.onprogress = function () {
                    }, p.ontimeout = function () {
                    }), e.auth) {
                        var h = e.auth.username || "", g = e.auth.password || "";
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
                ...
                a = t.I18N = function () {
                    ...
                    return e.prototype.processConfig = function (e) {
                        var t = this, r = Object.assign({}, l, e), o = r.location, n = function (e, t) {
                            var r = {};
                            for (var o in e) t.indexOf(o) >= 0 || Object.prototype.hasOwnProperty.call(e, o) && (r[o] = e[o]);
                            return r
                        }(r, ["location"]), i = o.replace(/\/?$/, "/");
                        this.config = Object.assign({}, {location: i}, n);
                        var a = this.config, s = a.override, d = a.preloaded, c = void 0 === d ? {} : d,
                        ...
                        if (r) {
                            var n = r.match(/\{[^}]+?\}/g), i = void 0;
                            if (t && n) if ("object" === (void 0 === t ? "undefined" : o(t))) for (var l = 0; l < n.length; l++) i = n[l].substring(1, n[l].length - 1), r = r.replace(this.makeSafe(n[l]), t[i] || ""); else r = r.replace(/\{[^}]+?\}/g, t);
                            return r
                        }
                        ...
                        var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], r = this;
                        return new Promise((function (o, n) {
                            ...
                            return (0, i.get)(l).then((function (t) {
                                var n = t.data, i = r.processFile(n);
                        ...
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            r = this.config.override[e] || {}, o = this.langs[e] || {};
            ...
            function a(e) {
                var t = new i(e), r = n(i.prototype.request, t);
 ...
 */
            ...
            a.prototype.request = function (e) {
                ...
                var t = [l, void 0], r = Promise.resolve(e);
        ...
        const i = {
            ...
            }, l = {btn: ["default", "danger", "info", "primary", "success", "warning"]}, a = {location: "assets/lang/"},
            s = {}, d = {
        ...
        function a(e) {
            for (var t = -1, r = 0; r < l.length; r++) if (l[r].identifier === e) {
                t = r;
                break
            }
            return t
        ...
        function s(e, t) {
            for (var r = {}, o = [], n = 0; n < e.length; n++) {
                var i = e[n], s = t.base ? i[0] + t.base : i[0], d = r[s] || 0, c = "".concat(s, " ").concat(d);
                r[s] = d + 1;
                var u = a(c), f = {css: i[1], media: i[2], sourceMap: i[3]};
        ...
        function f(e, t, r, o) {
            ...
            if (e.styleSheet) e.styleSheet.cssText = u(t, n); else {
                var i = document.createTextNode(n), l = e.childNodes;
                l[t] && e.removeChild(l[t]), l.length ? e.insertBefore(i, l[t]) : e.appendChild(i)
            }
        }

        function p(e, t, r) {
            var o = r.css, n = r.media, i = r.sourceMap;
        ...
        class i {
            ...
            label() {
                const e = this.data.label || "", t = [o.g.parsedHtml(e)];
        ...
        class a extends n.a {
            ...
            build() {
                const e = this.config, {values: t, type: r} = e, o = l(e, ["values", "type"]), n = e => {
                        const t = e.target.nextSibling.nextSibling, r = e.target.nextSibling, o = this.getActiveOption(t);
                        let n = new Map([[38, () => {
                        ...
                        focus: e => {
                            ...
                            if (0 == r.length) this.hideList(t); else {
                ...
                delete s.name;
                const c = [this.markup("input", null, s), this.markup("input", null, d)], u = t.map(e => {
                    const t = e.label, r = {
                        events: {
                            click: t => {
                                const r = t.target.parentElement, o = r.previousSibling.previousSibling;
            ...
            isOptionValid(e, t) {
                const r = e.querySelectorAll("li");
                let o = !1;
                for (let e = 0; e < r.length; e++) if (r[e].innerHTML === t) {
                    o = !0;
                    break
                }
                return o
            ...
            onRender(t) {
                if (this.config.userData) {
                    const t = e("#" + this.config.name), r = t.next(), o = this.config.userData[0];
                    let n = null;
        ...
        class p extends n.a {
            build() {
                const e = this.config, {type: t} = e, r = f(e, ["type"]);
                let o = t;
        ...
        class b extends n.a {
            ...
            build() {
                const e = [], t = this.config, {
                        ...
                        other: a,
                        toggle: s
                    } = t, d = m(t, ["values", "value", "placeholder", "type", "inline", "other", "toggle"]),
                    c = i.replace("-group", ""), f = "select" === i;
                ...
                if (delete d.title, r) {
                    ...
                    for (let t = 0; t < r.length; t++) {
                        ...
                        if (u.id = `${d.id}-${t}`, u.selected && !n || delete u.selected, void 0 !== o && u.value === o && (u.selected = !0), f) {
                            ...
                            const o = this.markup("input", null, Object.assign({}, d, u)), n = {for: u.id};
                    ...
                    if (!f && a) {
                        ...
                        const n = {
                                type: "text", events: {
                                    input: e => {
                                        const t = e.target, r = t.parentElement.previousElementSibling;
                            ...
                            s = this.markup("label", a, {for: o.id}), u = this.markup("div", [i, s], {className: r});
                        e.push(u)
                    }
                }
                ...
                if (this.config.userData) {
                    ...
                    "select" === this.config.type ? e(this.dom).val(t).prop("selected", !0) : this.config.type.endsWith("-group") && this.dom.querySelectorAll("input").forEach(e => {
                        if (!e.classList.contains("other-val")) {
                            for (let r = 0; r < t.length; r++) if (e.value === t[r]) {
        ...
        class g extends h {
            ...
            onRender() {
                const t = e(this.wrapper), r = e(this.input), o = jQuery.extend(!0, {
                    ...
                    callbacks: {
                        onError: (r, o, n) => {
                            ...
                            const i = t.fineUploader("getUploads"), l = [];
        ...
        class w extends n.a {
            ...
            build() {
                const e = this.config, {value: t = ""} = e, r = y(e, ["value"]);
        ...
        class x extends w {
            ...
            build() {
                const e = this.config, {value: t = ""} = e, r = v(e, ["value"]);
        ...
        class k extends w {
            ...
            build() {
                const e = this.config, {value: t = ""} = e, r = A(e, ["value"]);
                return delete r.type, this.field = this.markup("div", null, r), this.field
            }

            onRender(e) {
                const t = this.config.value || "", r = window.Quill.import("delta");
        ...
        var o = r(20), n = "object" == typeof self && self && self.Object === Object && self,
        ...
        var o = r(23), n = r(11), i = r(25), l = /^[-+]0x[0-9a-f]+$/i, a = /^0b[01]+$/i, s = /^0o[0-7]+$/i,
            d = parseInt;
        e.exports = function (e) {
        ...
        class y {
            ...
            beforeStop(e, t) {
                const r = this, o = m.a.opts, n = r.d.stage.childNodes.length - 1, i = [];
            ...
            getTypes(t) {
                const r = {type: t.attr("type")}, o = e(".fld-subtype", t).val();
                return o !== r.type && (r.subtype = o), r
            }

            fieldOptionData(t) {
                const r = [], o = e(".sortable-options li", t);
                return o.each(e => {
                    const t = o[e], n = t.querySelectorAll("input[type=text], input[type=number], select"),
                        i = t.querySelectorAll("input[type=checkbox], input[type=radio]"), l = {};
                    Object(p.j)(n, e => {
                        const t = n[e], r = t.dataset.attr;
                        l[r] = t.value
                    }), Object(p.j)(i, e => {
                        const t = i[e], r = t.getAttribute("data-attr");
                        l[r] = t.checked
                    }), r.push(l)
                }), r
            }
            ...
            xmlSave(e) {
                const t = this.prepData(e), r = new XMLSerializer, o = ["<fields>"];
                t.forEach(e => {
                ...
                if (0 !== t.childNodes.length) {
                    ...
                    Object(p.j)(t.childNodes, (function (t, r) {
                        ...
                        if (!i.hasClass("disabled-field")) {
                            let l = n.getTypes(i);
                            const a = e(".roles-field:checked", t), s = a.map(e => a[e].value).get();
                            if (l = Object.assign({}, l, n.getAttrVals(t)), l.subtype) if ("quill" === l.subtype) {
            ...
            save(e) {
                const t = this, r = this.data, o = this.d.stage,
            ...
            incrementId(e) {
                const t = e.lastIndexOf("-"), r = parseInt(e.substring(t + 1)) + 1;
                return `${e.substring(0, t)}-${r}`
            }

            getAttrVals(t) {
                const r = Object.create(null), o = t.querySelectorAll('[class*="fld-"]');
                return Object(p.j)(o, t => {
                    const n = o[t], i = Object(p.d)(n.getAttribute("name")),
            ...
            updatePreview(t) {
                const r = this.d, o = t.attr("class"), n = t[0];
                if (o.includes("input-control")) return;
                const i = t.attr("type"), a = e(".prev-holder", n);
                ...
                const d = h.a.lookup(s.type), c = d ? d.class : b.a.getClass(s.type, s.subtype),
            ...
            disabledTT(e) {
                ...
                Object(p.j)(t, e => {
                    const r = t[e], o = c.a.get("fieldNonEditable");
                    if (o) {
                        const e = Object(p.t)("p", o, {className: "frmb-tt"});
                        r.appendChild(e), r.addEventListener("mousemove", t => ((e, t) => {
                            const r = t.field.getBoundingClientRect(), o = e.clientX - r.left - 21,
            ...
            classNames(t, r) {
                const o = t.querySelector(".fld-className"), n = t.querySelector(".btn-style"), i = n && n.value;
                if (!o) return;
                const {type: l} = r, a = o.multiple ? e(o).val() : o.value.trim().split(" "),
            ...
            confirm(e, t, r = !1, o = "") {
                const n = this, i = c.a.current, l = n.showOverlay(),
            ...
            dialog(e, t = !1, r = "") {
                const o = document.documentElement.clientWidth, n = document.documentElement.clientHeight;
            ...
            confirmRemoveAll(t) {
                const r = this, o = t.target.id.match(/frmb-\d{13}/)[0], n = document.getElementById(o),
                    i = c.a.current, l = e("li.form-field", n), a = t.target.getBoundingClientRect(),
            ...
            removeAllFields(e) {
                const t = c.a.current, r = m.a.opts, o = [];
            ...
            closeField(t, r = !0) {
                const o = this, n = document.getElementById(t);
                if (!n) return n;
                const i = e(".frm-holder", n), l = e(".prev-holder", n);
                let a = !1;
                ...
                const c = s.find(".prev-holder"), f = setTimeout(() => {
                    clearTimeout(f);
            ...
            openField(t, r = !0) {
                const o = document.getElementById(t);
                if (!o) return o;
                const n = e(".frm-holder", o), i = e(".prev-holder", o);
                let l = !1;
                ...
                const a = e("#" + t), s = e(`#${t}-cont`), d = s.closest(this.formBuilder.rowWrapperClassSelector);
                return this.formBuilder.preserveTempContainers.push(s.attr("id")), a.insertAfter(d), this.formBuilder.currentEditPanel = n[0], m.a.opts.onOpenFieldEdit(n[0]), document.dispatchEvent(u.a.fieldEditOpened), e(document).trigger("fieldOpened", [{rowWrapperID: d.attr("id")}]), o
            }
            ...
            stickyControls() {
                const {controls: t, stage: r} = this.d, o = e(t).parent(),
                    n = t.getBoundingClientRect(), {top: i} = r.getBoundingClientRect();
                e(window).scroll((function (l) {
                    const a = e(l.target).scrollTop(), s = {top: 5, bottom: "auto", right: "auto", left: n.left},
                        d = Object.assign({}, s, m.a.opts.stickyControls.offset);
                    if (a > i) {
                        const e = {position: "sticky"}, n = Object.assign(e, d), i = t.getBoundingClientRect(),
                            l = r.getBoundingClientRect(), s = i.top + i.height, c = l.top + l.height,
                            u = s === c && i.top > a;
            ...
            removeField(t, r = 250) {
                let o = !1;
                const n = this, i = this.d.stage, l = i.getElementsByClassName("form-field");
                ...
                const s = e(a), d = s.closest(this.formBuilder.rowWrapperClassSelector);
            ...
            processSubtypes(e) {
                ...
                for (const e in o) if (o.hasOwnProperty(e)) {
                    const t = [];
                    for (const r of o[e]) {
                        const o = b.a.getClass(e, r), n = o.mi18n("subtype." + r) || o.mi18n(r) || r;
            ...
            editorUI(e) {
                const t = this.d, r = this.data, o = e || r.formID;
            ...
            processOptions(e) {
                const t = this, {actionButtons: r, replaceFields: o} = e, n = g(e, ["actionButtons", "replaceFields"]);
                ...
                const l = [{
                    ...
                    type: "button", id: "save", className: "btn btn-primary save-template", events: {
                        click: e => {
            ...
            tmpCleanPrevHolder(t) {
                const r = this, o = [], n = t.find(".form-group");
        ...
        class v {
            ...
            setupControls() {
                ...
                for (let e = 0; e < t.length; e++) {
                    ...
                    if (n) o = n.class; else if (n = {}, o = b.a.getClass(r), !o || !o.active(r)) continue;
            ...
            orderFields(e) {
                const t = this.opts, r = t.controlOrder.concat(e);
                let o;
        ...
        function I(e, t, r) {
            const o = this, n = c.a.current, a = "frmb-" + (new Date).getTime(), d = new s(a), b = new l.a(a);
            let h = [];
            ...
            const g = new e.layout(e.layoutTemplates, !0), A = new y(a, g, o), C = p.t;
            e = A.processOptions(e), d.layout = A.editorLayout(e.controlPosition), A.editorUI(a), d.formID = a, d.lastID = d.formID + "-fld-0";
            const I = new v(e, b), F = m.a.subtypes = A.processSubtypes(e.subtypes), P = r(b.stage), M = r(b.controls);
            let H, z, W = !1, U = !1, V = !1;
            ...
            const Y = t => {
                if (t[0].classList.contains("input-set-control")) {
                    const r = [], o = e.inputSets.find(e => Object(p.q)(e.name || e.label) === t[0].dataset.type);
                    if (o && o.showHeader) {
            ...
            X.appendChild(J), G.append(b.stage, X), "textarea" !== t.type ? r(t).append(G) : r(t).replaceWith(G), r(b.controls).on("click", "li", ({target: e}) => {
                if (R) return;
            ...
            const Z = (t, o = !1) => {
                let n = {};
                if (t instanceof jQuery) if (n.type = t[0].dataset.type, n.type) {
                    const e = I.custom.lookup(n.type);
                    if (e) n = Object.assign({}, e); else {
            ...
            const K = function (t) {
                (t = A.getData(t)) && t.length ? (t.forEach(e => {
                    ...
                    const t = [], o = t => C("li", e[t], {className: "disabled-field form-" + t});
            ...
            const _ = t => {
                const {type: r} = t, o = [], n = I.getClass(r), i = (e => {
                    const t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                        r = !["header", "paragraph", "file", "autocomplete"].concat(b.optionFields).includes(e), o = {
                    ...
                    access: () => {
                        ...
                        for (a in e.roles) if (e.roles.hasOwnProperty(a)) {
                ...
                if (Object.keys(i).forEach(t => {
                    const a = i[t], s = [!0], d = e.disabledAttrs.includes(a);
            ...
            function re(e, t) {
                const r = [], o = {
                    array: ne, string: oe, number: ae, boolean: (e, r) => {
                        let o = !1;
                        return "checkbox" === e.type ? o = Boolean(!!r.hasOwnProperty("value") && r.value) : t.hasOwnProperty(e) ? o = t[e] : (r.hasOwnProperty("value") || r.hasOwnProperty("checked")) && (o = r.value || r.checked || !1), ie(e, O(O({}, r), {}, {[e]: o}), {first: r.label})
                    }
                };
                for (const i in e) if (e.hasOwnProperty(i)) {
                    const l = ee(e[i]);
                    if ("undefined" !== l) {
                        const a = c.a.get(i), s = e[i], d = s.value || "";
            ...
            function ne(e, t) {
                const {multiple: r, options: o, label: i, value: l, class: a, className: s} = t,
                    ...
                    f = Object.keys(o).map(e => {
                        const t = {value: e}, r = o[e], n = Array.isArray(r) ? c.a.get(...r) || r[0] : r;
            ...
            const ie = (e, t, r = {}) => {
                ...
                return r.first && i.push(o(r.first)), r.second && l.push(" ", o(r.second)), r.content && l.push(r.content), l = C("div", l, {className: "input-wrap"}).outerHTML, C("div", i.concat(l), {className: `form-group ${e}-wrap`}).outerHTML
            }, le = e => {
                let t = "";
                ...
                return t += A.input({
                    ...
                    t += n
                }), t += "</div>", t = C("div", [r, t], {className: "form-group style-wrap"}), t.outerHTML
            }, ae = (e, t) => {
                const {class: r, className: o, value: n} = t, i = x(t, ["class", "className", "value"])[e] || n,
                    l = c.a.get(e) || e, a = {
                        type: "number",
                        value: i,
                        name: e,
                ...
                m.push(C("label", Object(p.x)(s), {className: "field-label"})), m.push(C("span", " *", {
                ...
                const x = C("li", m, {class: a + "-field form-field", type: a, id: d.lastID}), O = r(x);
                let q;
                if (fe(O), O.data("fieldData", {attrs: t}), void 0 !== A.stopIndex ? r("> li", b.stage).eq(A.stopIndex).before(O) : P.append(O), r(".sortable-options", O).sortable({update: () => A.updatePreview(O)}), A.updatePreview(O), Q()) {
                ...
                e.typeUserEvents[a] && e.typeUserEvents[a].onadd && e.typeUserEvents[a].onadd(x), i && (e.editOnAdd && (A.closeAllEdit(), A.toggleEdit(d.lastID, !1)), x.scrollIntoView && e.scrollToFieldOnAdd && x.scrollIntoView({behavior: "smooth"})), Q() && (W && V && Ee(q, !0), we()), W = !1, U = !1, V = !1
            };
            ...
            function he(t) {
                Q() && (r(t).sortable({
                    ...
                    over: function (e) {
                        const t = r(e.target), o = t.hasClass(E);
                    ...
                    receive: function (e, t) {
                        const o = r(t.sender).attr("id") == M.attr("id"), n = r(t.item).parent().hasClass(E),
                            i = r(t.item).parent().hasClass(E),
                            l = r(t.item).parent().hasClass(j) && !r(t.item).parent().hasClass(E);
                        if (n && !o) {
                            const e = r(t.item), o = xe({}), n = C("div", null, {
            ...
            const Ae = function (e, t) {
                const r = {selected: t ? "checkbox" : "radio"}, o = {
                    boolean: (e, t) => {
                ...
                const n = Object.entries(e).map(([e, t]) => {
                    const r = Object(p.n)(t), [n, i, l] = o[r](t, e), a = `option-${e} option-attr`;
            ...
            }, m.e, {leading: !1})), P.on("click touchstart", ".remove", t => {
                const o = r(t.target).parents(".form-field:eq(0)"), n = o[0], i = n.getAttribute("type"),
            ...
            P.on("change", [".prev-holder input", ".prev-holder select", ".prev-holder textarea"].join(", "), e => {
            ...
            }), P.on("keyup", "input.error", ({target: e}) => r(e).removeClass("error")), P.on("keyup", 'input[name="description"]', (function (e) {
                const t = r(e.target).parents(".form-field:eq(0)"), o = r(".tooltip-element", t), n = r(e.target).val();
                if ("" !== n) if (o.length) o.attr("tooltip", n).css("display", "inline-block"); else {
                ...
                const o = z.offset().top + z.outerHeight(), n = r(window).scrollTop() + r(window).innerHeight();
                o > n && z.css({top: parseInt(z.css("top")) - (o - n)})
            })), P.on("click touchstart", `.${w.a}copy`, (function (t) {
                t.preventDefault();
                const o = r(t.target).parent().parent("li"), n = function (t) {
                    d.lastID = A.incrementId(d.lastID), ge(t);
                    const o = t.attr("id"), n = t.attr("type"), i = n + "-" + (new Date).getTime(), l = t.clone();
                ...
                !function (e, t) {
                    ...
                    const o = r("#className-" + t.attr("id")), n = xe({}),
                ...
                t.preventDefault();
                const o = t.target.getBoundingClientRect(), n = document.body.getBoundingClientRect(),
                    i = {pageX: o.left + o.width / 2, pageY: o.top - n.top - 12},
                    l = r(t.target).parents(".form-field:eq(0)").attr("id"), a = r(document.getElementById(l));
                if (document.addEventListener("modalClosed", (function () {
                    a.removeClass("deleting")
                }), !1), e.fieldRemoveWarn) {
                    const e = C("h3", c.a.get("warning")), t = C("p", c.a.get("fieldRemoveWarning"));
            ...
            function Ee(e, t = !1) {
                const o = e.children("div" + T).length, n = Math.floor(12 / o);
            ...
            function Ne(e) {
                if (e) {
                    ...
                    if (t.val()) {
                        const e = A.getRowClass(t.val()), r = A.getRowClass(t.closest(S).attr("class"));
            ...
            function Le() {
                ...
                Ce.closest(S).children("div" + T).each((e, t) => {
                    const o = r("#" + t.id).find("li").attr("id"), n = r("#" + o).attr("type");
            ...
            if (P.on("click touchstart", ".grid-button", e => {
                ...
                if (je) {
                    e.preventDefault();
                    const t = Ce.closest("div"), o = A.getBootstrapColumnValue(t.attr("class"));
                    let n;
                ...
                const t = r(e.target), o = t.closest(".form-elements"), n = t.val(), i = r(".btn-style", o);
                ...
                const t = r(e.target).closest(".form-field").find(".available-roles"), o = r(e.target);
                t.slideToggle(250, (function () {
                    o.is(":checked") || r("input[type=checkbox]", t).removeAttr("checked")
                }))
            })), P.on("click", ".add-opt", (function (e) {
                e.preventDefault();
                const t = r(e.target).closest(".form-field").attr("type"), o = r(e.target).closest(".field-options"),
                    n = r('[name="multiple"]', o), i = r(".option-selected:eq(0)", o);
                let l = !1;
                l = n.length ? n.prop("checked") : "checkbox" === i.attr("type");
                const a = r(".sortable-options", o), s = m.a.opts.onAddOption({selected: !1, label: "", value: ""}, {
                    type: t,
            ...
            return document.dispatchEvent(u.a.loaded), o.actions = {
                ...
                save: e => {
                    const t = A.save(e), r = window.JSON.parse(t);
        ...
        const F = {
            init: (e, t) => {
                const r = jQuery.extend({}, m.d, e, !0), {i18n: o} = r, n = x(r, ["i18n"]);
                m.a.opts = n;
