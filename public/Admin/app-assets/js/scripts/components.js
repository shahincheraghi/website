...
(function (window, document, $) {
  ...
  var alertValidationInput = $(".alert-validation"),
    ...
    dropdownMenuIcon = $(".dropdown-icons-wrapper .dropdown-item");
  ...
  dropdownMenuIcon.on("click", function () {
    $(".dropdown-icons-wrapper .dropdown-toggle i").remove();
    $(this).find("i").clone().appendTo(".dropdown-icons-wrapper .dropdown-toggle");
    $(".dropdown-icons-wrapper .dropdown-toggle .dropdown-item").removeClass("dropdown-item");
  });
+
