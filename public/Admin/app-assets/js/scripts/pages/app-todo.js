...
$(function() {
  ...
  // --------------------------------------------
  $(".todo-application .sidebar-close-icons").on('click',function(){
      ...
      $(".todo-task-list-wrapper").append('<li class="todo-item" style="animation-delay: 0s;"  data-toggle="modal" data-target="#editTaskModal">' +
        '<div class="todo-title-wrapper d-flex justify-content-between mb-50">' +
              ...
              '<div class="vs-checkbox-con">' +
                  ...
                  '<span class="vs-checkbox vs-checkbox-sm">' +
                    '<span class="vs-checkbox--check">' +
                      '<i class="vs-icons feather icons-check"></i>' +
                    '</span>' +
                  '</span>' +
              '</div>' +
          ...
          '<div class="float-right todo-item-action d-flex">' +
            '<a class="todo-item-info'+ todoInfo +'"><i class="feather icons-info"></i></a>' +
            '<a class="todo-item-favorite'+ todoFav +'"><i class="feather icons-star"></i></a>' +
            '<a class="todo-item-delete"><i class="feather icons-trash"></i></a>' +
          '</div>' +
        '</div>' +
