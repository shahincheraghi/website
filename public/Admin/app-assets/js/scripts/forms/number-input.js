...
(function (window, document, $) {
  ...
  $(".touchspin-icons").TouchSpin({
    buttondown_txt: '<i class="feather icons-chevron-down"></i>',
    buttonup_txt: '<i class="feather icons-chevron-up"></i>'
  });
  ...
  $(".touchspin-color").each(function (index) {
    ...
    $this.TouchSpin({
      ...
      buttonup_class: up,
      buttondown_txt: '<i class="feather icons-minus"></i>',
      buttonup_txt: '<i class="feather icons-plus"></i>'
    });
  });
