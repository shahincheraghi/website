...
(function (window, document, $) {
  ...
  $(window).on("load", function () {
    ...
    $('a[data-action="reload"]').on("click", function () {
      ...
      // Block Element
      block_ele.block({
        message: '<div class="feather icons-refresh-cw icons-spin font-medium-2 text-primary"></div>',
  ...
  $(".dropdown-language .dropdown-item").on("click", function () {
    ...
    var selectedFlag = $this.find(".flag-icons").attr("class");
    $("#dropdown-flag .selected-language").text(selectedLang);
    $("#dropdown-flag .flag-icons")
      .removeClass()
  ...
  bookmarkStar.on("click", function (e) {
    ...
    for (var i = 0; i < arrList.length; i++) {
      ...
      $arrList +=
        ...
        "</span>" +
        "</div>" +
        '<span class="float-right bookmark-icons feather icons-star warning"></span>' +
        "</a>" +
        "</li>";
    }
      ...
      if (value != "") {
        ...
        $.getJSON("../../../app-assets/data/" + $filename + ".json", function (
          ...
          for (var i = 0; i < data.listItems.length; i++) {
            // if current is bookmark then give class to star icons
            if (bookmark === true) {
              ...
              $bookmarkIcon =
                '<span class="float-right bookmark-icons feather icons-star' +
                activeClass +
                '"></span>';
            }
  ...
  // Favorite star click
  $(document).on("click", ".bookmark-input .search-list .bookmark-icons", function (e) {
    e.stopPropagation();
