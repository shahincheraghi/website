...
<!-- Mirrored from shreethemes.in/landrick/layouts/index-blockchain.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Mar 2021 22:05:38 GMT -->
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-home d-flex align-items-center" style="background: url('images/crypto/bg.jpg') top;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading fw-bold text-white title-dark mb-3">محبوب ترین روش خرید در دنیا, <br> نگه دارید ، و از رمزنگاری استفاده کنید</h4>
                            <h5 class="para-desc mx-auto text-light title-dark">خودکار دقیق کارآمد.</h5>
                            <div class="mt-4 pt-2">
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <img src="images/crypto/lapy01.png" class="img-fluid" alt="">
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <img src="images/crypto/iphone.png" class="img-fluid" alt="">
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
        ...
        <!-- Start CTA -->
        <section class="section pb-0" style="background: url('images/crypto/bg.jpg') center;">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="mt-4 pt-2">
                            <img src="images/crypto/cta.png" class="img-fluid d-block mx-auto" alt="">
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
