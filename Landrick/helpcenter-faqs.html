                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">گفت و گو </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-5 col-12 d-none d-md-block">
                        <div class="rounded shadow p-4 sticky-bar">
                            <ul class="list-unstyled sidebar-nav mb-0 py-0" id="navmenu-nav">
                                <li class="navbar-item my-2 px-0"><a href="#tech" class="h6 text-dark navbar-link">سوالات خرید</a></li>
                                <li class="navbar-item my-2 px-0"><a href="#general" class="h6 text-dark navbar-link">سوالات عمومی</a></li>
                                <li class="navbar-item my-2 px-0"><a href="#payment" class="h6 text-dark navbar-link">سوالات پرداخت</a></li>
                                <li class="navbar-item my-2 px-0"><a href="#support" class="h6 text-dark navbar-link">سوالات پشتیبانی</a></li>
                            </ul>
                        </div>
                    </div><!--end col-->
