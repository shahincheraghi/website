                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="title-heading">
                            <h1 class="heading text-white title-dark mb-4">تجزیه و تحلیل قدرتمند <br> با ابزار عالی برای شما</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-light"><i class="uil uil-envelope align-middle"></i> شروع کنید </a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="d-flex features feature-clean p-4 bg-white shadow rounded">
                                        ...
                                        <div class="flex-1 content ms-4">
                                            <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">گپ فوری</a></h5>
                                ...
                                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                    <div class="d-flex features feature-clean p-4 bg-white shadow rounded">
                                        ...
                                        <div class="flex-1 content ms-4">
                                            <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">پیام های رسانه ای</a></h5>
                                            <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده است.</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-md-6 mt-4 pt-2">
                                    <div class="d-flex features feature-clean p-4 bg-white shadow rounded">
                                        ...
                                        <div class="flex-1 content ms-4">
                                            <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">پیام های ویدئویی</a></h5>
                                            <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده است.</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-md-6 mt-4 pt-2">
                                    <div class="d-flex features feature-clean p-4 bg-white shadow rounded">
                                        ...
                                        <div class="flex-1 content ms-4">
                                            <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">سرور اختصاصی</a></h5>
                                            <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده است.</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <img src="images/landing/3.jpg" class="img-fluid rounded-md shadow-lg" alt="">
                    </div><!--end col-->

                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="section-title text-md-start text-center">
                            <h4 class="title mb-4">با خودتان همکاری کنید <br> تیم در هر زمان و هر مکان.</h4>
                            ...
                            <div class="d-flex align-items-center text-start mt-4 pt-2">
                                ...
                                <div class="flex-1">
                                    <a href="javascript:void(0)" class="text-dark h6">سرنخ های بهتری پیدا کنید</a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center text-start mt-4">
                                ...
                                <div class="flex-1">
                                    <a href="javascript:void(0)" class="text-dark h6">تنظیم جلسه فوری</a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center text-start mt-4">
                                ...
                                <div class="flex-1">
                                    <a href="javascript:void(0)" class="text-dark h6">بدون درنگ پرداخت کنید</a>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section bg-light">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title text-center text-lg-start">
                            <h6 class="text-primary">همکاران </h6>
                            <h4 class="title mb-4 mb-lg-0">مدیریت مشتریان شما <br> به صورت هوشمندانه</h4>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="section-title text-md-start text-center">
                            <h4 class="title mb-4">سوالی دارید؟</h4>
                            <p class="text-muted mb-0 para-desc">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
