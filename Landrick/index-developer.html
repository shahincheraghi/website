        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <ul class="buy-button list-inline mb-0">
                    ...
                    <li class="list-inline-item mb-0">
                        <a href="javascript:void(0)" class="btn btn-icon btn-soft-primary" data-bs-toggle="modal" data-bs-target="#loginform"><i class="uil uil-user icons"></i></a>
                    </li>
                </ul><!--end login button-->
                <!-- End Logo container-->
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="title-heading">
                            <span class="badge rounded-pill bg-soft-primary">توسعه </span>
                            <h1 class="fw-bold mt-2 mb-3">ترکیب کامل با <br> بهترین سایت ساز دنیا</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary me-2">شروع کنید </a>
                                <a href="javascript:void(0)" class="btn btn-outline-primary">اسناد </a>
                            </div>
                            <p class="text-muted mb-0 mt-3">نسخه فعلی: ورژن : 3.1.1</p>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">کلمات کلیدی</h4>
                            <p class="para-desc text-muted mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 mt-4 pt-2">
                        <div class="card border-0 features feature-clean course-feature p-4 overflow-hidden shadow">
                            ...
                            <div class="card-body p-0 mt-4">                                            
                                <a href="javascript:void(0)" class="title h5 text-dark">مدولار </a>
                                <p class="text-muted mt-2">ساخته شده به زبان شبه لاتین که کم و بیش مطابقت دارد.</p>
                                <a href="javascript:void(0)" class="text-primary read-more">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 mt-4 pt-2">
                        <div class="card border-0 features feature-clean course-feature p-4 overflow-hidden shadow">
                            ...
                            <div class="card-body p-0 mt-4">                                            
                                <a href="javascript:void(0)" class="title h5 text-dark">ریسپانسیو </a>
                                <p class="text-muted mt-2">ساخته شده به زبان شبه لاتین که کم و بیش مطابقت دارد.</p>
                                <a href="javascript:void(0)" class="text-primary read-more">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 mt-4 pt-2">
                        <div class="card border-0 features feature-clean course-feature p-4 overflow-hidden shadow">
                            ...
                            <div class="card-body p-0 mt-4">                                            
                                <a href="javascript:void(0)" class="title h5 text-dark">سفارشی سازی</a>
                                <p class="text-muted mt-2">ساخته شده به زبان شبه لاتین که کم و بیش مطابقت دارد.</p>
                                <a href="javascript:void(0)" class="text-primary read-more">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 mt-4 pt-2">
                        <div class="card border-0 features feature-clean course-feature p-4 overflow-hidden shadow">
                            ...
                            <div class="card-body p-0 mt-4">                                            
                                <a href="javascript:void(0)" class="title h5 text-dark">مقیاس پذیر </a>
                                <p class="text-muted mt-2">ساخته شده به زبان شبه لاتین که کم و بیش مطابقت دارد.</p>
                                <a href="javascript:void(0)" class="text-primary read-more">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h6 class="text-primary">شروع سریع </h6>
                            <h4 class="title mb-4">عالیه نه؟ بیایید غواصی کنیم!</h4>
                            <p class="para-desc mx-auto text-muted mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-mg-10 mt-4 pt-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded bg-soft-light" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link nav-link-alt rounded active" id="pills-npm-tab" data-bs-toggle="pill" href="#pills-npm" role="tab" aria-controls="pills-npm" aria-selected="false">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link nav-link-alt rounded" id="pills-nuget-tab" data-bs-toggle="pill" href="#pills-nuget" role="tab" aria-controls="pills-nuget" aria-selected="false">
                                                <div class="text-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link nav-link-alt rounded" id="pills-spm-tab" data-bs-toggle="pill" href="#pills-spm" role="tab" aria-controls="pills-spm" aria-selected="false">
                                                <div class="text-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link nav-link-alt rounded" id="pills-github-tab" data-bs-toggle="pill" href="#pills-github" role="tab" aria-controls="pills-github" aria-selected="false">
                                                <div class="text-center">
                                ...
                                <div class="col-12">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-npm" role="tabpanel" aria-labelledby="pills-npm-tab">
                                            <p class="text-muted fw-bold mb-0"><span class="text-success">هزار تومان </span> npm نصب <span class="text-success">-g</span> claps.js</p>
                                        </div><!--end teb pane-->
                                        
                                        <div class="tab-pane fade" id="pills-nuget" role="tabpanel" aria-labelledby="pills-nuget-tab">
                                            <p class="text-muted fw-bold mb-0">به زودی ...</p>                       
                                        </div><!--end teb pane-->
                        ...
                        <ul class="list-unstyled text-muted mb-0 mt-3">
                            <li class="list-inline-item me-lg-5 me-4"><span class="text-success h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>داده های خود را سازماندهی کنید</li>
                            <li class="list-inline-item me-lg-5 me-4"><span class="text-success h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>با هر تیمی کار کنید</li>
                        </ul>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title me-lg-5">
                            <h4 class="title mb-4">ابزار بسازید و <br> توسعه بدهید</h4>
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary">ادامه مطلب  <i data-feather="arrow-left" class="fea icon-sm"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-4">نرخ ما برای توسعه دهنده از تیم لندریک</h4>
                            <p class="para-desc mx-auto text-muted mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card pricing-rates business-rate border-0 p-4 rounded-md shadow">
                            <div class="card-body p-0">
                                <span class="py-2 px-4 d-inline-block bg-soft-primary h6 mb-0 text-primary rounded-lg">پایه </span>
                                <h2 class="fw-bold mb-0 mt-3">9000 تومان</h2>
                                <p class="text-muted">هر ماه </p>

                                <p class="text-muted">تمام اصول اولیه برای مشاغل تازه شروع شده.</p>
                                ...
                                <div class="mt-4">
                                    <div class="d-grid">
                                        <button class="btn btn-primary">اکنون بخرید</button>
                                    </div>
                                    <p class="text-muted mt-3 mb-0">*بدون کارت اعتباری مورد نیاز است</p>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card pricing-rates business-rate border-0 p-4 rounded-md shadow">
                            ...
                            <div class="card-body p-0">
                                <span class="py-2 px-4 d-inline-block bg-soft-primary h6 mb-0 text-primary rounded-lg">شرکتی </span>
                                <h2 class="fw-bold mb-0 mt-3">39000 تومان</h2>
                                <p class="text-muted">هر ماه </p>

                                <p class="text-muted">برای مشاغل در حال رشد که مشتری بیشتری می خواهند بهتر است.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card pricing-rates business-rate border-0 p-4 rounded-md shadow">
                            <div class="card-body p-0">
                                <span class="py-2 px-4 d-inline-block bg-soft-primary h6 mb-0 text-primary rounded-lg">شرکت، پروژه
                                <h2 class="fw-bold mb-0 mt-3">79000 تومان</h2>
                                <p class="text-muted">هر ماه </p>

                                <p class="text-muted">ویژگی های پیشرفته برای افراد حرفه ای که نیاز به سفارشی سازی بیشتری دارند.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">آیا می خواهید در میان اولین کسی باشید که می فهمد؟</h4>
                            ...
                            <div class="subcribe-form mt-4 pt-2">
                                <form>
                                    <div class="">
                                        <input type="email" id="email" name="email" class="border bg-white rounded-pill" required placeholder="آدرس ایمیل">
        ...
        <div class="modal fade" id="loginform" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content rounded shadow-lg border-0 overflow-hidden position-relative">
                    <button type="button" class="btn-close position-absolute top-0 end-0 mt-2 me-2" style="z-index: 1" data-bs-dismiss="modal" aria-label="بستن"></button>
