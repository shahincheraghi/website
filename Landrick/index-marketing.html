                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-lg-7 col-md-7 text-center">
                        ...
                        <div class="title-heading mt-0 mt-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                            <h1 class="heading mb-3">بازاریابی از طریق رسانه های اجتماعی بهترین است</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary mt-2 me-2">شروع کنید </a>
                                <a href="page-contact-one.html" class="btn btn-outline-primary mt-2"><i class="mdi mdi-phone"></i> تماس با ما</a>
                            </div>
                        </div>
                    </div>
                </div><!--end row-->
        ...
        <section class="section bg-light">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">ویژگی های نمونه</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4 pt-2 text-center">
                        <a href="javascript:void(0)" class="btn btn-primary">نمایش بیشتر <i class="uil uil-angle-left align-middle"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">مشتریان گرانقدر ما</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">شروع کنید !</h4>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary m-1">اکنون بخرید <span class="badge rounded-pill bg-danger ms-2">ورژن 3.1.1 </span></a>
