                    ...
                    <li class="list-inline-item mb-0 pe-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dd-menu dropdown-menu-end bg-white shadow rounded border-0 mt-3 p-4" style="width: 300px;">
                                ...
                                <p class="text-muted text-start mt-1 mb-0">* لنـدریــک  </p>
                            </div>
                        </div>
                    </li>
                    <li class="list-inline-item mb-0 pe-1">
                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">حساب من </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="d-flex align-items-center">
                            <img src="images/client/05.jpg" class="avatar avatar-md-md rounded-circle" alt="">
                            <div class="ms-3">
                                <h6 class="text-muted mb-0">سلام ، </h6>
                                <h5 class="mb-0">جعفر عباسی</h5>
                            </div>
                        </div>
                        ...
                        <ul class="nav nav-pills nav-justified flex-column bg-white rounded mt-4 shadow p-3 mb-0" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link rounded active" id="dashboard" data-bs-toggle="pill" href="#dash" role="tab" aria-controls="dash" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                        <h6 class="mb-0"><i class="uil uil-dashboard h5 align-middle me-2 mb-0"></i> داشبورد </h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="order-history" data-bs-toggle="pill" href="#orders" role="tab" aria-controls="orders" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                        <h6 class="mb-0"><i class="uil uil-list-ul h5 align-middle me-2 mb-0"></i> سفارشات</h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="download" data-bs-toggle="pill" href="#down" role="tab" aria-controls="down" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                        <h6 class="mb-0"><i class="uil uil-arrow-circle-down h5 align-middle me-2 mb-0"></i> دانلود ها</h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="addresses" data-bs-toggle="pill" href="#address" role="tab" aria-controls="address" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                        <h6 class="mb-0"><i class="uil uil-map-marker h5 align-middle me-2 mb-0"></i> آدرس ها</h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="account-details" data-bs-toggle="pill" href="#account" role="tab" aria-controls="account" aria-selected="false">
                                    <div class="text-start py-1 px-3">
                                        <h6 class="mb-0"><i class="uil uil-user h5 align-middle me-2 mb-0"></i> جزئیات حساب</h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                    ...
                    <div class="col-md-8 col-12 mt-4 pt-2">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade bg-white show active shadow rounded p-4" id="dash" role="tabpanel" aria-labelledby="dashboard">
                                <h6 class="text-muted">سلام <span class="text-dark">Jafar_abbasi</span> (نیستید <span class="text-dark">Jafar_abbasi</span>? <a href="javascript:void(0)" class="text-danger">خروج</a>)</h6>

                                <h6 class="text-muted mb-0">از داشبورد حساب خود می توانید خود را مشاهده کنید <a href="javascript:void(0)" class="text-danger">سفارشات اخیر</a>, با مدیریت شما <a href="javascript:void(0)" class="text-danger">آدرس حمل و نقل و صورتحساب</a>, و <a href="javascript:void(0)" class="text-danger">رمز ورود و جزئیات حساب خود را ویرایش کنید</a>.</h6>
                            </div><!--end teb pane-->
                                    ...
                                    <table class="table mb-0 table-center table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="javascript:void(0)" class="text-primary">نمایش <i class="uil uil-arrow-right"></i></a></td>
                                            </tr>
                                    ...
                                    <table class="table mb-0 table-center table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-muted">گفته می شود آهنگسازان آهنگ گذشته <br> هنگام نوشتن از متن ساختگی به عنوان شعر استفاده می کرد <br> ملودی به منظور داشتن "آماده" است' <br> متن برای خواندن با ملودی.</td>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="email" id="email" type="email" class="form-control ps-5" value="callyjoseph@gmail.com">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    <i data-feather="user-check" class="fea icon-sm icons"></i>
                                                    <input name="name" id="display-name" type="text" class="form-control ps-5" value="Jafar_abbasi">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
