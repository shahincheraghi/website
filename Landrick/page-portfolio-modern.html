                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">نمونه کار ها</a></li>
            ...
            <div class="container">
                ...
                <div id="grid" class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                ...
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">تغییر دیدگاه</a>
                                    <small class="text-light">استودیو </small>
                                </div>
                                <div class="client">
                                    <small class="text-light user d-block"><i class="uil uil-user"></i> کالوین لورس</small>
                                    <small class="text-light date"><i class="muil uil-calendar-alt"></i> اردیبهشت 1400</small>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["designing"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                ...
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">مجله رنگها</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["photography"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                ...
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">لوازم آرایشی اسپا </a>
                                    <small class="text-light">در حال توسعه </small>
                                </div>
                                <div class="client">
                                    <small class="text-light user d-block"><i class="uil uil-user"></i> کالوین لورس</small>
                                    <small class="text-light date"><i class="muil uil-calendar-alt"></i> اردیبهشت 1400</small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["development"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                ...
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">قهوه رایزر</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/5.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">رقصیدن با خودم</a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/6.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">روندهای جدید در سئو</a>
                                    <small class="text-light">کسب و کار </small>
                                </div>
                                <div class="client">
                                    <small class="text-light user d-block"><i class="uil uil-user"></i> کالوین لورس</small>
                                    <small class="text-light date"><i class="muil uil-calendar-alt"></i> اردیبهشت 1400</small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["designing"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/7.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">تغییر دیدگاه</a>
                                    <small class="text-light">استودیو </small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["development"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/8.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">مجله رنگها</a>
                                    <small class="text-light">طراحی وب </small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/9.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">لوازم آرایشی اسپا </a>
                                    <small class="text-light">در حال توسعه </small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["designing"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/10.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">قهوه رایزر</a>
                                    <small class="text-light">برندینگ </small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["photography"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/11.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">رقصیدن با خودم</a>
                                    <small class="text-light">عکاسی </small>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["development"]'>
                        <div class="card work-container work-modern position-relative overflow-hidden shadow rounded border-0">
                            <div class="card-body p-0">
                                <img src="images/work/12.jpg" class="img-fluid rounded" alt="work-image">
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <a href="page-portfolio-detail.html" class="title text-white d-block fw-bold">روندهای جدید در سئو</a>
                                    <small class="text-light">کسب و کار </small>
