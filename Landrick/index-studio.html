                ...
                <div class="row position-relative align-items-center pt-4">
                    <div class="col-lg-7 offset-lg-5">
                        <div class="title-heading studio-home rounded bg-white shadow mt-5">
                            <h1 class="heading mb-3">کار خود را با <span class="text-primary"> لنـدریـک  </span> شروع کنید </h1>
                            ...
                            <div class="mt-4">
                                <a href="page-contact-one.html" class="btn btn-primary mt-2 me-2"><i class="uil uil-phone"></i> شروع کنید </a>
                                <a href="documentation.html" class="btn btn-outline-primary mt-2"><i class="uil uil-book-alt"></i> اسناد </a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">فرآیند کار</h4>
                ...
                <div class="row">
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="card work-process border-0 rounded shadow">
                            <div class="card-body">
                                <h4 class="title">بحث درباره پروژه ساز است </h4>
                                <p class="text-muted para">به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است.</p>
                                ...
                                <ul class="list-unstyled d-flex justify-content-between mb-0 mt-2">
                                    <li class="step h1 mb-0 fw-bold">مرحله  01.</li>
                                    <li class="step-icon"><i class="uil uil-angle-double-left h1 mb-0"></i></li>
                                </ul>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="card work-process border-0 rounded shadow">
                            <div class="card-body">
                                <h4 class="title">توسعه و جزئیات</h4>
                                <p class="text-muted para">به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است.</p>
                                <a href="javascript:void(0)" class="text-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                                <ul class="list-unstyled d-flex justify-content-between mb-0 mt-2">
                                    <li class="step h1 mb-0 fw-bold">مرحله  02.</li>
                                    <li class="step-icon"><i class="uil uil-angle-double-left h1 mb-0"></i></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="card work-process border-0 rounded shadow">
                            <div class="card-body">
                                <h4 class="title">تأیید نهایی</h4>
                                <p class="text-muted para">به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است.</p>
                                <a href="javascript:void(0)" class="text-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                                <ul class="list-unstyled d-flex justify-content-between mb-0 mt-2">
                                    <li class="step h1 mb-0 fw-bold">مرحله 3.</li>
            ...
            <div class="container mt-100 pt-50">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center mt-4 pt-2">
                        <a href="page-portfolio-modern.html" class="btn btn-primary">نمایش بیشتر <i class="uil uil-angle-left align-middle"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">همه چیز را در مورد خود ببینید محل کار </h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        
                            <div class="mt-3">
                                <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary mt-2 me-2">اکنون بخرید <span class="badge rounded-pill bg-danger ms-2">ورژن 3.1.1 </span></a>
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#LoginForm" class="btn btn-outline-primary mt-2"><i class="uil uil-user-check"></i> رایگان امتحان کنید</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-2 mb-0">
                                        <div class="d-grid">
                                            <button class="btn btn-primary">وارد شوید </button>
                                        </div>
                                    </div><!--end col-->
                                </div>
                            </form>   
