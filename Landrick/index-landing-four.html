                ...
                <div class="row align-items-center mt-5">
                    <div class="col-lg-7 col-md-6">
                        <div class="title-heading">
                            <span class="badge rounded-pill bg-soft-success">لندینگ چهار</span>
                            <h4 class="heading my-3">تجربه , <br>تخصص ، مشاوره</h4>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary m-1">کاووش بیشتر</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="card shadow rounded border-0 ms-lg-4">
                            <div class="card-body">
                                <h5 class="card-title text-center">30 روز آزمایش رایگان دریافت کنید</h5>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <span class="badge rounded-pill bg-soft-primary">ویژگی ها </span>
                            <h4 class="title mt-3 mb-4">چه کاری انجام می دهیم؟</h4>
                            <p class="text-muted para-desc mx-auto mb-0">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card border-0 text-center features feature-clean rounded">
                            <div class="icons text-primary text-center mx-auto">
                                <i class="uil uil-envelope-lock d-block rounded h3 mb-0"></i></h3>
                            </div>

                            <div class="card-body p-0 mt-4">
                                <h5>کاملاً امن </h5>
                                <p class="text-muted mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                <div class="mt-2">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card border-0 text-center features feature-clean rounded">
                            <div class="icons text-primary text-center mx-auto">
                                <i class="uil uil-edit d-block rounded h3 mb-0"></i></h3>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card border-0 text-center features feature-clean rounded">
                            <div class="icons text-primary text-center mx-auto">
                                <i class="uil uil-circle-layer d-block rounded h3 mb-0"></i></h3>
                            </div>

                            <div class="card-body p-0 mt-4">
                                <h5>طراحی و مارک تجاری</h5>
                                <p class="text-muted mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                <div class="mt-2">
                                    <a href="javascript:void(0)" class="text-primary">ادامه مطلب  <i data-feather="arrow-left" class="fea icon-sm"></i></a>
                                </div>
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                        <div class="ms-lg-5">
                            <div class="section-title mb-3">
                                <span class="badge rounded-pill bg-soft-primary">دیدار با آینده</span>
                                <h4 class="title my-3">معرفی راهی جدید</h4>
                            ...
                            <ul class="list-unstyled text-muted">
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>کاملا ریسپانسیو</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>طرح چندگانه</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>متناسب با سبک شما</li>
                            </ul>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6 mt-4 pt-2">
                                                <div class="section-title text-md-start">
                                                    ...
                                                    <h4 class="title text-white title-dark mb-0">دیدار با تجربه <br> و اعضا تیم </h4>
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-12 mt-4 pt-md-2">
                                                <div class="section-title text-md-start">
                                                    <p class="text-white-50 para-desc">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                                                    <a href="javascript:void(0)" class="text-white title-dark">ادامه مطلب  <i data-feather="arrow-left" class="fea icon-sm"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نرخ راحت</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="section-title">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-1 ms-md-4 ms-3">
                                        <h4 class="fw-bold text-light title-dark mb-1">مشترک شدن در خبرنامه های ما</h4>
                                        <p class="text-white-50 mb-0">ثبت نام کنید و آخرین نکات را از طریق ایمیل دریافت کنید.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mt-4 mt-sm-0">
                            <div class="text-md-end ms-5 ms-sm-0">
                                <a href="javascript:void(0)" class="btn btn-primary">مشترک شوید </a>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end container-->
