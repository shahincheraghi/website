                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">کار </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="sidebar sticky-bar p-4 rounded shadow">
                            ...
                            <div class="widget mb-4 pb-4 border-bottom">
                                ...
                                <div class="mt-4 mb-0">
                                    <select class="form-select form-control" aria-label="به طور پیش فرض مثال انتخاب کنید">
                                        ...
                                        <option>دیجیتال و خلاق</option>
                                        <option>حسابداری </option>
                                        <option>بانکی </option>
                                        <option>پیمانکار فناوری اطلاعات </option>
                                        <option>فارغ التحصیل </option>
                                        <option>آژانسی</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Categories -->
                            ...
                            <!-- Job Type -->
                            <div class="widget mb-4 pb-4 border-bottom">
                                <h5 class="widget-title">نوع شغل </h5>
                                <div class="mt-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="contract">
                                        <label class="form-check-label" for="contract">پایه قرارداد</label>
                                    </div>
    
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="freelancer">
                                        <label class="form-check-label" for="freelancer">فریلنسر</label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="parttime">نیمه وقت</label>
                                    </div>
    
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="remote">
                                        <label class="form-check-label" for="remote">از راه دور</label>
                                    </div>
    
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="intern">
                                        <label class="form-check-label" for="intern">کارآموزی </label>
                                    </div>
                                </div>
                            </div>
                            <!-- Job Type -->
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">طراحی وب</a>
                                        ...
                                        <ul class="list-unstyled head mb-0">
                                            <li class="badge bg-success rounded-pill">تمام وقت </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">کایرکل </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> ساعت کار - 6</li>
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> استراتژی اطلاعات</li>
                                        </ul>
                                        <div class="d-grid">
                                            <a href="page-job-detail.html" class="btn btn-outline-primary">اعمال کنید </a>
                                        </div>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">توسعه وب</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">کد نویسی </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">طراحان تجربه کاربری</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                        ...
                                        <ul class="list-unstyled head mb-0">
                                            <li class="badge bg-warning rounded-pill">نیمه وقت </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">اختلاف </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">UI طراح </a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">اسلینت </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">توسعه دهنده بک اند</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                        ...
                                        <ul class="list-unstyled head mb-0">
                                            <li class="badge bg-danger rounded-pill">از راه دور</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">گیتلاب </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">عکاس </a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">گریدل </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">مکانیک </a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">مجله </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">طراح فرانت اند</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">طرح </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">توئلیو </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">توسعه دهنده php</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">آموزشی </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    ...
                                    <div class="card-body content position-relative">
                                        ...
                                        <div class="company-detail text-center mt-3">
                                            <h5 class="mb-0"><a href="page-job-company.html" class="text-dark company-name">وب هوک </a></h5>
                                            <p class="text-muted"><a href="#" class="text-muted"><i data-feather="map-pin" class="fea icon-sm"></i> ایران</a></p>
                                        </div>
                                        <ul class="job-facts list-unstyled">
                                            <li class="list-inline-item text-muted"><i data-feather="check" class="fea icon-sm text-success me-1"></i> 2 تجربه کار </li>
                            ...
                            <div class="col-lg-6 col-12 mb-4 pb-2">
                                <div class="card job-box rounded shadow border-0 overflow-hidden">
                                    <div class="border-bottom">
                                        ...
                                        <h5 class="mb-0 position"><a href="page-job-detail.html" class="text-dark">توسعه دهنده پایتون</a>
                                            <ul class="list-unstyled h6 mb-0 text-warning">
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
                                                <li class="list-inline-item mb-0"><i class="mdi mdi-star"></i></li>                                    
