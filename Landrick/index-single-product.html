...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-home d-flex align-items-center" style="background: url('images/single/bg01.jpg') center center; height: auto;" id="home">
            <div class="bg-overlay bg-overlay-white"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                        <div class="title-heading margin-top-100">
                            <h1 class="display-4 fw-bold mb-3">دوربین بدون سرنشین DJI حرفه ای</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i data-feather="video" class="icons"></i></a><span class="fw-bold text-uppercase small align-middle ms-1">اکنون تماشا کنید </span>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-6 p-4 text-center">
                        ...
                        <h5 class="mt-2">تصویر </h5>
                        <p class="text-muted mb-0">48 مگاپیکسل در 60 متر</p>
                    </div><!--end col-->
                    
                    <div class="col-md-3 col-6 p-4 text-center">
                        <img src="images/icon/speedometer.svg" height="45" alt="">
                        <h5 class="mt-2">سرعت </h5>
                        <p class="text-muted mb-0">50 kph</p>
                    </div><!--end col-->
                    
                    <div class="col-md-3 col-6 p-4 text-center">
                        <img src="images/icon/low-battery.svg" height="45" alt="">
                        <h5 class="mt-2">باتری </h5>
                        <p class="text-muted mb-0">1 ساعت و 30 دقیقه</p>
                    </div><!--end col-->
                    
                    <div class="col-md-3 col-6 p-4 text-center">
                        <img src="images/icon/game.svg" height="45" alt="">
                        <h5 class="mt-2">کنترل </h5>
                        <p class="text-muted mb-0">20 کیلومتر برد</p>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-3">
                            <h4 class="title mb-4">دوربین DJI 48MP</h4>
                            ...
                            <a href="javascript:void(0)" class="mt-3 text-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">ویژگی های عالی</h4>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="camera" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">دوربین 48 مگاپیکسلی</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="wifi" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">اتصال سریع تر</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">کار با آن آسان </h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="video" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">فیلم پایدار</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="rss" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">آنتن قدرتمند</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="battery" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">پشتیبان گیری باتری</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            <div class="icon text-center rounded-circle me-3">
                                <i data-feather="cpu" class="fea icon-ex-md text-primary"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="title mb-0">پیشرفته فناوری </h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">جداسازی قطعات آسان</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">ساختار مقاوم</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <div class="position-relative">
                            ...
                            <div class="play-icon">
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="play-btn shadow lightbox">
        ...
        <section class="section bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">بازخورد مشتری</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="tiny-single-item">
                            <div class="tiny-slide">
                                <img src="images/single/01.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/02.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/03.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/04.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/05.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/06.jpg" class="img-fluid rounded" alt="">
                            </div>

                            <div class="tiny-slide">
                                <img src="images/single/07.jpg" class="img-fluid rounded" alt="">
                            </div>                            
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-md-4">
                            <h4 class="title mb-4">اسپروک دون</h4>
                            <div class="d-flex justify-content-between my-4">
                                <h4 class="mb-0"><b>18 هزار تومان</b></h4>
                                <div class="text-warning">
                                    ...
                                    <span class="text-muted ps-2">23 نظرات </span>
                                </div>
                            </div>
                            <p class="text-muted para-desc mx-auto">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند. این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>
                            <ul class="list-unstyled text-muted">
                                <li><i class="mdi mdi-check me-2"></i>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li><i class="mdi mdi-check me-2"></i>پوست خود را متناسب با نام تجاری خود ایجاد کنید</li>
                                <li><i class="mdi mdi-check me-2"></i>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li><i class="mdi mdi-check me-2"></i>پوست خود را متناسب با نام تجاری خود ایجاد کنید</li>
                            </ul>
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary">خرید از راست چین </a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center mt-4 pt-2">
                    <div class="col-lg-7 col-md-10">
                        <div class="text-center subcribe-form mt-4 pt-2">
                            <form>
                                <input name="email" id="email" type="email" class="form-control rounded-pill border" placeholder="ایمیل شما:" required aria-describedby="newssubscribebtn">
