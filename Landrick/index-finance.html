...
<head>
    ...
    <body>
        ...
        <!-- Start Hero -->
        <section class="bg-half-260 d-table w-100" data-jarallax='{"speed": 0.5}' style="background:url('images/finance/bg.jpg') top">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="title-heading">
                            ...
                            <h1 class="heading fw-bold mb-3">کم حال شما برا ساخت انواع سایت  <span class="text-primary text-decoration-underline typewrite" data-period="2000" data-type='[ "آژانسی", "شرکتی", "استارت آپ", "فروشگاهی" ]'> <span class="wrap"></span> </span> <br> رشد تا سطح بالا</h1>
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-4">
                        <div class="card features fea-primary text-center rounded-0 px-4 py-5 bg-light bg-gradient position-relative overflow-hidden border-0">
                            ...
                            <div class="card-body p-0 content">
                                <h5>استراتژی </h5>
                                <p class="para text-muted mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده خواهد شد خواهد بود از در طرح آن.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                        <div class="ms-lg-4">
                            <div class="section-title">
                                ...
                                <h4 class="title mb-4 mt-3">ما طراحی و توسعه می دهیم <br> برای اینکه شما راحت باشید.</h4>
                                <p class="text-muted para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند. به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است.</p>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            ...
                            <h4 class="title mt-3 mb-4">به دنیای جدید و خلاق بپیوندید. <br> با طراحی مدرن و جدید!</h4>
                            <p class="text-muted mx-auto para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 mt-2">
                        <div class="px-md-4 pt-4 text-center">
                            <h4 class="mb-3">خدمات فردی</h4>
                            <p class="text-muted mb-0">گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به ترتیب.</p>

                            <div class="position-relative mt-5">
                                <div class="bg-overlay bg-primary bg-gredient rounded-md" style="opacity: 0.6;"></div>
                                <img src="images/finance/1.jpg" class="rounded-md shadow img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 mt-2">
                        <div class="px-md-4 pt-4 text-center">
                            <h4 class="mb-3">خدمات سازمان</h4>
                            <p class="text-muted mb-0">گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به ترتیب.</p>

                            <div class="position-relative mt-5">
                                <div class="bg-overlay bg-primary bg-gredient rounded-md" style="opacity: 0.6;"></div>
                                <img src="images/finance/2.jpg" class="rounded-md shadow img-fluid" alt="">
                            </div>
        ...
        <!-- CTA Start -->
        <section class="section bg-cta" data-jarallax='{"speed": 0.5}' style="background: url('images/finance/cta.jpg') center center;" id="cta">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title title-dark text-white mb-4">دست از گذاشتن پول روی میز بردارید.</h4>
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-4">شهادت نامه</h4>
                            <p class="text-muted mx-auto para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
