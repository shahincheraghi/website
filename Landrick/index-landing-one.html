                ...
                <div class="row position-relative" style="z-index: 1;">
                    <div class="col-md-7 col-12 mt-lg-5">
                        <div class="title-heading">
                            <h1 class="heading text-white title-dark mb-4">مخاطبان خود را بسازید <br> و فروش بیشتر</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary m-1">شروع کنید </a>
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i data-feather="video" class="icons"></i></a><span class="fw-bold text-uppercase text-white-50 small align-middle ms-2">اکنون تماشا کنید </span>
                            </div>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container">
                <div class="row justify-ontent-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-4">راه حل هایی که برای شما ساخته شده است</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4 pt-2 text-center">
                        <a href="javascript:void(0)" class="btn btn-primary">نمایش بیشتر <i class="mdi mdi-arrow-right"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--ed container-->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section-title text-center text-lg-start">
                            <h4 class="title mb-4">مشتری مطمئن توسط جعفر <br> <span class="text-primary"> 10000+ </span> از جهان </h4>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6 mt-4 pt-2">
                                                <div class="section-title text-md-start">
                                                    <h6 class="text-white-50">نیاز های مشتریان</h6>
                                                    <h4 class="title text-white mb-0 title-dark">همه چیز را کنترل کنید <br> در یک مکان واحد</h4>
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-12 mt-4 pt-md-2">
                                                <div class="section-title text-md-start">
                                                    <p class="text-white-50 para-desc">شروع به کار با <span class="text-light title-dark"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                                                    <a href="javascript:void(0)" class="text-light title-dark">ادامه مطلب  <i data-feather="arrow-left" class="fea icon-sm"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="section-title text-md-start text-center">
                            <h4 class="title mb-4">مشتریان ما چه میگویند؟ <br> هر چیزی درباره لنـدریــک  </h4>
                            <p class="text-muted mb-0 para-desc">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">همه چیز را در مورد خود ببینید کارمند در یک مکان.</h4>
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary mt-2 me-2">اکنون شروع کنید</a>
                                <a href="javascript:void(0)" class="btn btn-outline-primary mt-2">رایگان امتحان کنید</a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
