...
<head>
    ...
    <body>
                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="title-heading mt-4">
                            <div class="alert alert-white alert-pills shadow" role="alert">
                                ...
                                <span class="content"> ساخته شده برای <span class="text-primary">همه ی مشاغل </span> شما به لنـدریــک نیاز دارید..</span>
                            </div>
                            <h1 class="heading mb-3">پیشرو در تجارت دیجیتال برای <span class="text-primary typewrite" data-period="2000" data-type='[ "آژانسی", "نرم افزار", "تکنولوژی", "استدیو", "اپ وب" ]'> <span class="wrap"></span> </span> با بهترین امکانات </h1>
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-outline-primary rounded"><i class="uil uil-store"></i> فروشگاه خود را بسازید </a>
                            </div>
                        </div>
                    </div><!--end col-->
        ...
        <!-- CTA Start -->
        <section class="section bg-cta" data-jarallax='{"speed": 0.5}' style="background: url('images/2.jpg');" id="cta">
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">قیمت گذاری ساده را انتخاب کنید</h4>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title">
                            <h4 class="title mb-4">همه چیز را در مورد خود ببینید <span class="text-primary"> لنـدریـک  </span> کسب و کار شماست </h4>
                                    ...
                                    <div class="col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                        <div class="card counter-box border-0 bg-light bg-gradient shadow text-center rounded">
                                            <div class="card-body py-5">
                                                ...
                                                <h5 class="counter-head mb-0">مشتریان خوشحال </h5>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card counter-box border-0 bg-primary bg-gradient shadow text-center rounded">
                                            <div class="card-body py-5">
                                                ...
                                                <h5 class="counter-head mb-0 title-dark text-light">جوایز </h5>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end Row-->
                                ...
                                <div class="row pt-lg-4 mt-lg-4">
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card counter-box border-0 bg-success bg-gradient shadow text-center rounded">
                                            <div class="card-body py-5">
                                                <h2 class="text-light title-dark mb-0"><span class="counter-value" data-target="2">0</span>هزار </h2>
                                                <h5 class="counter-head mb-0 title-dark text-light">موقعیت شغلی</h5>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card counter-box border-0 bg-light bg-gradient shadow text-center rounded">
                                            <div class="card-body py-5">
                                                ...
                                                <h5 class="counter-head mb-0">پروژه های تکمیلی</h5>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end Row-->
