...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-260 bg-primary d-table w-100" style="background: url('images/software/bg.png') center center;">
                ...
                <div class="row align-items-center position-relative mt-5" style="z-index: 1;">
                    <div class="col-lg-6 col-md-12">
                        <div class="title-heading mt-4 text-center text-lg-start">
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-light"><i class="uil uil-file-download"></i> اکنون دانلود کنید</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-6 col-md-12 mt-4 pt-2">
                        <div class="position-relative">
                            <div class="software_hero">
                                <img src="images/software/software.png" class="img-fluid d-block" alt="">
                            </div>
                            <div class="play-icon">
        ...
        <section class="section pt-md-4 pt-5">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features text-center">
                            ...
                            <div class="content mt-4">
                                <h5>بازاریابی از طریق رسانه های اجتماعی</h5>
                ...
                <div class="row justify-content-center mt-5 pt-4">
                    <div class="col-lg-10 col-md-12">
                        <img src="images/software/mobile-hori.png" class="img-fluid d-block mx-auto" alt="">
                    </div><!--end col-->
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-5 mt-4 mt-sm-0">
                                <div class="text-sm-end">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary"><i class="uil uil-file-bookmark-alt"></i> شروع کنید </a>
                                </div>
                            </div><!--end col-->
                        </div><!--end row -->
                    </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <img src="images/software/mobile01.png" class="img-fluid" alt="">
                    </div><!--end col-->

                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">ابتکارات بازاریابی را انجام دهید: لندریک</h4>
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">برنامه عالی خود را انتخاب کنید</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            ...
                            <div class="mt-4 pt-2">
                                <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary">شروع کنید <span class="badge rounded-pill bg-danger ms-2">ورژن 3.1.1 </span></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
