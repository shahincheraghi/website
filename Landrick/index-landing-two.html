                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="title-heading mt-4">
                            <h1 class="display-4 fw-bold mb-3">لندینگ حرفه ای <br> برای ساخت انواع سایت</h1>
                        ...
                        <div class="form-check mt-3">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">تایید میکنم <a href="#" class="text-primary">قوانین سایت لنـدریـک را و تیکت را فعال میکنم</a></label>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h6 class="text-primary">ویژگی ها </h6>
                            <h4 class="title mb-4">ویژگی های جذاب</h4>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">طراحی و توسعه </a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">مدیریت و بازاریابی </a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">استراتژی و تحقیقات</a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">استفاده آسان</a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">گزارش های روزانه</a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card features feature-clean explore-feature p-4 px-md-3 border-0 rounded-md shadow text-center">
                            ...
                            <div class="card-body p-0 content">
                                <h5 class="mt-4"><a href="javascript:void(0)" class="title text-dark">منطقه زمان واقعی</a></h5>
                                <p class="text-muted">مشهورترین متن ساختگی "لورم اپیسوم" است که گفته می شود ریشه دارد</p>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <img src="images/landing/1.jpg" class="img-fluid rounded-md shadow-lg" alt="">
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="sticky-bar">
                            <div class="section-title text-lg-start text-center mb-4 mb-lg-0 pb-2 pb-lg-0">
                                <h6 class="text-primary">نظرات </h6>
                                <h4 class="title mb-4">مردم عاشق ما هستند</h4>
                                <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            </div>
                        </div>
                    </div><!--end col-->
