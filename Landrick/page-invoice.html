                        ...
                        <div class="card shadow rounded border-0">
                            <div class="card-body">
                                <div class="invoice-top pb-4 border-bottom">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="logo-invoice mb-2">لنـدریــک <span class="text-primary">.</span></div>
                                            <a href="https://www.rtl-theme.com/landrick-html-template/" class="text-primary h6"><i data-feather="link" class="fea icon-sm text-muted me-2"></i>خرید فقط از راست چین </a>
                                        </div><!--end col-->
                                ...
                                <div class="invoice-middle py-4">
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-8 order-2 order-md-1">
                                            <dl class="row">
                                                <dt class="col-md-3 col-5 fw-normal">شماره تلفن. :</dt>
                                                <dd class="col-md-9 col-7 text-muted">land45845621</dd>
                                                
                                                <dt class="col-md-3 col-5 fw-normal">نام :</dt>
                                                <dd class="col-md-9 col-7 text-muted">کالوین لورس</dd>
                                                
                                                <dt class="col-md-3 col-5 fw-normal">آدرس : </dt>
                                                <dd class="col-md-9 col-7 text-muted">
                                                    <p class="mb-0">ارومیه، شاهین دژ,</p>
                                                    <p class="mb-0">قزلناو، پلاک 4</p>
                                                </dd>
                                                
                                                <dt class="col-md-3 col-5 fw-normal">تلفن :</dt>
                                        ...
                                        <div class="col-md-4 order-md-2 order-1 mt-2 mt-sm-0">
                                            <dl class="row mb-0">
                                                <dt class="col-md-4 col-5 fw-normal">تاریخ :</dt>
                                                <dd class="col-md-8 col-7 text-muted">اردیبهشت 1400</dd>
                                            </dl>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table mb-0 table-center invoice-tb">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-start">بینش فراگیر</td>
                                                    <td>2</td>
                                                    <td>26000 تومان</td>
                                                    <td>46000 تومان</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-start">راهنمای مفید</td>
                                                    <td>1</td>
                                                    <td>36000 تومان</td>
                                                    <td>36000 تومان</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-start">محصول برتر</td>
                                                    <td>3</td>
                                                    <td>45900 تومان</td>
                                                    <td>139900 تومان</td>
                                                </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-5 ms-auto">
                                            <ul class="list-unstyled h6 fw-normal mt-4 mb-0 ms-md-5 ms-lg-4">
                                                <li class="text-muted d-flex justify-content-between">مجموع :<span>541000 تومان</span></li>
                                                <li class="text-muted d-flex justify-content-between">مالیات :<span> 0</span></li>
                                                <li class="d-flex justify-content-between">مجموع کل :<span>541000 تومان</span></li>
                                            </ul>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="text-sm-start text-muted text-center">
                                                <h6 class="mb-0">خدمات مشتری : <a href="tel:+152534-468-854" class="text-warning">(+12) 1546-456-856</a></h6>
                                            </div>
                                        </div>
    
                                        <div class="col-sm-6">
                                            <div class="text-sm-end text-muted text-center">
                                                <h6 class="mb-0"><a href="page-terms.html" target="_blank" class="text-primary">شرایط و ضوابط</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
