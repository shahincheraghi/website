                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">داوطلب</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="candidate-list card rounded border-0 shadow">
                            <div class="card-body">
                                ...
                                <div class="content text-center">
                                    ...
                                    <div class="d-grid">
                                        <a href="page-job-candidate.html" class="btn btn-soft-primary">ادامه مطلب  <i class="uil uil-angle-left-b align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="candidate-list card rounded border-0 shadow">
                            <div class="card-body">
                                ...
                                <div class="content text-center">
                                    ...
                                    <a href="page-job-candidate.html" class="text-dark h5 name">نیکولاس </a>
                        ...
                        <div class="candidate-list card rounded border-0 shadow">
                            <div class="card-body">
                                ...
                                <div class="content text-center">
                                    ...
                                    <a href="page-job-candidate.html" class="text-dark h5 name">جنیفر لوپز </a>
                        ...
                        <div class="candidate-list card rounded border-0 shadow">
                            <div class="card-body">
                                ...
                                <div class="content text-center">
                                    ...
                                    <a href="page-job-candidate.html" class="text-dark h5 name">الکس تام </a>
