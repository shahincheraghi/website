                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12">
                        <div class="title-heading text-center">
                            <h1 class="heading title-dark text-white mb-3">خدمات ابری و راه حل میزبانی وب</h1>
                            <p class="para-desc para-dark mx-auto text-muted">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                            <div class="mt-4 pt-2">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <form class="p-4 shadow bg-white rounded">
                            <h4 class="mb-3">دامنه خود را اکنون جستجو کنید</h4>
                            <div class="row">
                                <div class="col-12">
                                    <div class="input-group mb-3">
                                        <input name="name" id="name" type="text" class="form-control rounded-left" placeholder="نام دامنه شما :">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.ir <br><span class="text-primary">40 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.com <br><span class="text-primary">500 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.org <br><span class="text-primary">600 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.net <br><span class="text-primary">700 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.info <br><span class="text-primary">100 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-6 mt-4">
                                    <a href="javascript:void(0)" class="text-dark">
                                        <div class="rounded shadow bg-white p-1 text-center">
                                            <h6 class="mb-0">.me <br><span class="text-primary">200 هزار تومان</span>/ سال </h6>
                                        </div>
                                    </a>
                                </div><!--end col-->
                            </div><!--end row-->
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-lg-9 col-md-8 text-sm-start">
                        <div class="section-title">
                            <h4 class="title mb-4">خدمات میزبانی ابری</h4>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h5>نام دامنه </h5>
                                <p class="text-muted">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است..</p>
                                <a href="javascript:void(0)" class="text-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-5 pt-3">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h5>هاست ابری </h5>
                                <p class="text-muted">گفته می شود ، یک محقق لاتین با تدوین کلمه ای غیر معمول ، اصل متن ایجاد شده را تأسیس کرد.</p>
                                <a href="javascript:void(0)" class="text-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section bg-light">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">با ابر میزبانی بهترین برنامه را برای قدرت بیشتر دریافت کنید</h4>
                            ...
                            <a href="javascript:void(0)" class="btn btn-primary mt-3">شروع کنید <i class="uil uil-angle-left-b"></i></a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title">
                            <h4 class="title mb-4">با بهترین راه حل هاست وب سازش ندهید</h4>
                            <p class="text-muted">استفاده از لندریک برای ساخت سایت شما به معنای هرگز نگرانی در مورد طراحی صفحه دیگر یا سازگاری با مرورگر نیست. کتابخانه سازنده و اجزای سازنده و طرح های از پیش طراحی شده ما ، زندگی شما را آسان تر می کند.</p>
                            <ul class="list-unstyled text-muted">
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>پوست خود را متناسب با نام تجاری خود ایجاد کنید</li>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">بستر قدرتمند سرور و هاست وب</h4>
                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                            <ul class="list-unstyled text-muted">
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نرخ میزبانی ما</h4>
                        ...
                        <div class="text-center">
                            <ul class="nav nav-pills rounded-pill justify-content-center d-inline-block border py-1 px-2" id="pills-tab" role="tablist">
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link px-3 rounded-pill active monthly" id="Monthly" data-bs-toggle="pill" href="#Month" role="tab" aria-controls="Month" aria-selected="true">ماهانه </a>
                                </li>
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link px-3 rounded-pill yearly" id="Yearly" data-bs-toggle="pill" href="#Year" role="tab" aria-controls="Year" aria-selected="false">سالی <span class="badge rounded-pill bg-success">15% تخفیف  </span></a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                                        <div class="card pricing-rates bg-light rounded border-0">
                                            <div class="card-body py-5">
                                                <h6 class="title text-uppercase fw-bold mb-4">هاست ابری </h6>
                                                ...
                                                <ul class="list-unstyled mb-0 ps-0">
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>2 گیگ فضا</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>10 بهینه سازی رایگان</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>24/7 پشتیبانی </li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>بهینه سازی محتوا </li>
                                                </ul>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                                        <div class="card pricing-rates starter-plan bg-white shadow rounded border-0">
                                            <div class="card-body py-5">
                                                <h6 class="title text-uppercase fw-bold text-primary mb-4">میزبانی اختصاصی</h6>
                                                <div class="d-flex mb-4">
                                                    <span class="h4 mb-0 mt-2">هزار تومان </span>
                                                ...
                                                <ul class="list-unstyled mb-0 ps-0">
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>4 گیگ فضا</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>10 بهینه سازی رایگان</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>24/7 پشتیبانی </li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>بهینه سازی محتوا </li>
                                                </ul>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                                        <div class="card pricing-rates bg-light rounded border-0">
                                            <div class="card-body py-5">
                                                <h6 class="title text-uppercase fw-bold mb-4">VPS هاست</h6>
                                                <div class="d-flex mb-4">
                                                    <span class="h4 mb-0 mt-2">هزار تومان </span>
                                                ...
                                                <ul class="list-unstyled mb-0 ps-0">
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>8 گیگ فضا</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>10 بهینه سازی رایگان</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>24/7 پشتیبانی </li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>بهینه سازی محتوا </li>
                                                </ul>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                                        <div class="card pricing-rates bg-light rounded border-0">
                                            <div class="card-body py-5">
                                                <h6 class="title text-uppercase fw-bold mb-4">هاست اشتراکی </h6>
                                                <div class="d-flex mb-4">
                                                    <span class="h4 mb-0 mt-2">هزار تومان </span>
                                                ...
                                                <ul class="list-unstyled mb-0 ps-0">
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>16 گیگ فضا</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>10 بهینه سازی رایگان</li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>24/7 پشتیبانی </li>
                                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>بهینه سازی محتوا </li>
                                                </ul>
