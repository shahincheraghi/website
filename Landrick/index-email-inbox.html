                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                        <div class="title-heading margin-top-100">
                            <h1 class="heading fw-bold mb-3">ما یک طرح می سازیم <br> برای صندوق ورودی ایمیل</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="#about" class="btn btn-primary">آزمایش رایگان را شروع کنید <i class="uil uil-angle-left-b"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="home-dashboard">
                                    <img src="images/email/home.png" alt="" class="img-fluid rounded-md shadow-lg" style="z-index: 0;">
                                </div>
                            </div>
                        </div><!--end row-->
                    </div><!--end col-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-4">ویژگی های ما</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-5">
                        <div class="d-flex features feature-clean">
                            ...
                            <div class="flex-1 content ms-4">
                                <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">همکاری تیمی</a></h5>
                                <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده است.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-5">
                        <div class="d-flex features feature-clean">
                            ...
                            <div class="flex-1 content ms-4">
                                <h5 class="mb-1"><a href="javascript:void(0)" class="text-dark">اپ ریسپاتسیو </a></h5>
                                <p class="text-muted mb-0">مشهورترین متن ساختگی متن است که گفته می شود از قرن شانزدهم شروع شده است.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">وب سایت خود را بسازید <br> رشد با بازدید کنندگان سطح بعدی</h4>
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 order-2 order-md-1">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">تجارت ما را ملاقات کنید <br> شریکی که در پشت صحنه کار می کند</h4>
                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                            <ul class="list-unstyled text-muted">
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">آنچه مشتریان ما در مورد آن گفته اند <span class="text-primary">لنـدریـک </span> پروژه ساز است </h4>
                ...
                <div class="row align-items-end mb-4 pb-2">
                    <div class="col-md-8">
                        <div class="section-title text-center text-md-start">
                            <h4 class="title mb-4">بهترین ها را انتخاب کنید <br> یکی برای شما </h4>
                        ...
                        <div class="text-center text-md-end">
                            <ul class="nav nav-pills bg-white rounded-lg justify-content-center d-inline-block shadow py-1 px-2 mb-0" id="pills-tab" role="tablist">
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link px-3 rounded-lg active monthly" id="Monthly" data-bs-toggle="pill" href="#Month" role="tab" aria-controls="Month" aria-selected="true">ماهانه </a>
                                </li>
                                <li class="nav-item d-inline-block">
                                    <a class="nav-link px-3 rounded-lg yearly" id="Yearly" data-bs-toggle="pill" href="#Year" role="tab" aria-controls="Year" aria-selected="false">سالانه </a>
                                </li>
                            </ul>
                        </div>
                    </div><!--end col-->
                                        ...
                                        <div class="card pricing-rates business-rate shadow bg-light border-0 rounded">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex mb-4">
                                                    <span class="h6 mb-0 mt-2">هزار تومان </span>
                                                    <span class="price h1 mb-0">0</span>
                                                    <span class="h5 align-self-end mb-1"> /ماهانه </span>
                                                </div>
