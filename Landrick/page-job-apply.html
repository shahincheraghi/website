                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            <h4 class="title"> فرم درخواست شغل </h4>
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">فرم درخواست شغل</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <form class="rounded shadow p-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">تلفن شما :<span class="text-danger">*</span></label>
                                                <div class="form-icon position-relative">
                                                    <i data-feather="phone" class="fea icon-sm icons"></i>
                                                    <input name="number" id="number" type="number" class="form-control ps-5" placeholder="تلفن شما :">
                                                </div>
                                            </div> 
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input name="subject" id="subject" class="form-control ps-5" placeholder="عنوان:">
                                                </div>
                                            </div>                                                                               
                                        </div><!--end col-->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <textarea name="comments" id="comments" rows="4" class="form-control ps-5" placeholder="شغل را توصیف کنید :"></textarea>
                                                </div>
                                            </div>
                                        </div><!--end col-->                                    
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="formFile" class="form-label">رزومه / رزومه خود را بارگذاری کنید :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <input type="submit" id="submit" name="send" class="submitBnt btn btn-primary" value="اکنون اعمال کنید">
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </form><!--end form-->
                            </div> 
