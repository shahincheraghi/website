                ...
                <div class="row align-items-center mt-5 mt-sm-0">
                    <div class="col-md-6">
                        <div class="title-heading text-center text-md-start">
                            <span class="badge rounded-pill bg-soft-primary">فریلنسری </span>
                            <h4 class="heading mb-3 mt-2">مستقل خود را رشد دهید <span class="fw-bold"> کسب و کار برای شماست </span></h4>
                            <p class="text-muted mb-0 para-dark para-desc mx-auto ms-md-auto">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                            
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary">ثبت نام کنید و رشد را شروع کنید</a>
                                <p class="text-muted mt-1 mb-0">*بدون کارت اعتباری مورد نیاز است</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="freelance-hero position-relative">
                            <div class="bg-shape position-relative">
                                <img src="images/freelancer/freelancer.png" class="mx-auto d-block img-fluid" alt="">
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-12 order-1 order-lg-2">
                        <div class="section-title text-center text-lg-start mb-4 mb-lg-0 pb-2 pb-lg-0">
                            <span class="badge rounded-pill bg-soft-primary">خدمات </span>
                            <h4 class="title mt-3 mb-4">بیشتر بساز ، کمتر مدیریت کن</h4>
                            <p class="text-muted para-desc mx-auto ms-lg-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            <div class="mt-4 d-lg-block d-none">
                                <a href="javascript:void(0)" class="btn btn-primary">نمایش بیشتر</a>
                            </div>
                        </div>
                    </div><!--end col-->
                                ...
                                <div class="row">
                                    <div class="col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                        <div class="card border-0 text-center features feature-clean course-feature p-4 overflow-hidden shadow">
                                            ...
                                            <div class="card-body p-0 mt-4">                                            
                                                <a href="javascript:void(0)" class="title h5 text-dark">هدفمند <br> با سرنخ های با کیفیت بالا </a>
                                                <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده در طرح آن.</p>
                                    ...
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card border-0 text-center features feature-clean course-feature p-4 overflow-hidden shadow">
                                            ...
                                            <div class="card-body p-0 mt-4">                                            
                                                <a href="javascript:void(0)" class="title h5 text-dark">ارسال ، برنامه ریزی و تعویق ایمیل ها</a>
                                                <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده در طرح آن.</p>
                                ...
                                <div class="row pt-lg-4 mt-lg-4">
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card border-0 text-center features feature-clean course-feature p-4 overflow-hidden shadow">
                                            ...
                                            <div class="card-body p-0 mt-4">                                            
                                                <a href="javascript:void(0)" class="title h5 text-dark">کتابخانه بهترین الگوهای ایمیل</a>
                                                <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده در طرح آن.</p>
                                    ...
                                    <div class="col-12 mt-4 pt-2">
                                        <div class="card border-0 text-center features feature-clean course-feature p-4 overflow-hidden shadow">
                                            ...
                                            <div class="card-body p-0 mt-4">                                            
                                                <a href="javascript:void(0)" class="title h5 text-dark">یادآوری های پیگیری خودکار</a>
                                                <p class="text-muted mt-2 mb-0">این یک واقعیت ثابت شده طولانی است که یک خواننده در طرح آن.</p>
                        ...
                        <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-0 sticky-bar" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link rounded active" id="proposal" data-bs-toggle="pill" href="#developing" role="tab" aria-controls="developing" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-postcard me-2 h5"></i> پیشنهادات </h6>
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="contract" data-bs-toggle="pill" href="#data-analise" role="tab" aria-controls="data-analise" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-notes me-2 h5"></i> قراردادها </h6>
                                        <i class="uil uil-angle-left-b"></i>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="crm" data-bs-toggle="pill" href="#security" role="tab" aria-controls="security" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-folder-check me-2 h5"></i> مدیریت مشتریان </h6>
                                        <i class="uil uil-angle-left-b"></i>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="timetracking" data-bs-toggle="pill" href="#time-track" role="tab" aria-controls="time-track" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-clock me-2 h5"></i> ردیابی زمان</h6>
                                        <i class="uil uil-angle-left-b"></i>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="invoice" data-bs-toggle="pill" href="#invoices" role="tab" aria-controls="invoices" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-invoice me-2 h5"></i> صورتحساب </h6>
                                        <i class="uil uil-angle-left-b"></i>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link rounded" id="tasktracking" data-bs-toggle="pill" href="#task-track" role="tab" aria-controls="task-track" aria-selected="false">
                                    <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                        <h6 class="mb-0"><i class="uil uil-exchange-alt me-2 h5"></i> پیگیری وظیفه</h6>
                                        <i class="uil uil-angle-left-b"></i>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                    ...
                    <div class="col-md-8 col-12 mt-4 pt-2">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade bg-white show active p-4 rounded shadow" id="developing" role="tabpanel" aria-labelledby="proposal">
                                <h4 class="mb-4">کار بیشتر برنده شوید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">پیشنهادها را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded shadow" id="data-analise" role="tabpanel" aria-labelledby="contract">
                                <h4 class="mb-4">از تجارت خود محافظت کنید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">قراردادها را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded shadow" id="security" role="tabpanel" aria-labelledby="crm">
                                <h4 class="mb-4">منظم بمانید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">پروژه ها را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded shadow" id="time-track" role="tabpanel" aria-labelledby="timetracking">
                                <h4 class="mb-4">ساده نگه دارید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">ردیابی زمان را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded shadow" id="invoices" role="tabpanel" aria-labelledby="invoice">
                                <h4 class="mb-4">سریعتر پرداخت کنید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">فاکتور را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                            ...
                            <div class="tab-pane fade bg-white p-4 rounded shadow" id="task-track" role="tabpanel" aria-labelledby="tasktracking">
                                <h4 class="mb-4">موثرتر باشید</h4>
                                <p class="text-muted mb-0">این مورد زمانی الزامی است که مثلاً متن نهایی هنوز در دسترس نیست. متن ساختگی به عنوان 'متن پر نیز شناخته می شود'. گفته می شود که آهنگسازان آهنگ های گذشته از متن ساختگی به عنوان شعر استفاده می کردند هنگام نوشتن ملودی به منظور داشتن متن "آماده" برای آواز خواندن با ملودی.</p>

                                <div class="mt-4">
                                    <a href="javascript:void(0)" class="text-primary h6">پیگیری وظیفه را کاوش کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title mb-4 pb-2 text-center">
                            <h4 class="title mb-4">بله ، در واقع کار می کند.</h4>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 order-1 order-md-2">
                        <img src="images/freelancer/cta.png" class="img-fluid" alt="">
                    </div><!--end col-->

                    <div class="col-lg-6 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">مشتریان جدید و مشتریان قبلی را به کار با درآمد بیشتری تبدیل کنید</h4>
                            ...
                            <a href="javascript:void(0)" class="mt-3 h6 text-primary">اطلاعات بیشتر <i class="uil uil-angle-left-b"></i></a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                    ...
                    <div class="col-lg-7 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title">
                            <div class="alert alert-light alert-pills" role="alert">
                                <span class="badge bg-primary rounded-pill me-1">اپلیکیشن </span>
                                <span class="content">اکنون دانلود کنید <i class="uil uil-angle-left-b align-middle"></i></span>
                            </div>
                            <h4 class="title mb-4">موجود برای گوشی های  <br> هوشمند </h4>
                            ...
                            <div class="my-4">
                                <a href="javascript:void(0)" class="btn btn-lg btn-dark mt-2 me-2"><i class="uil uil-apple"></i> اپ استور</a>
                                <a href="javascript:void(0)" class="btn btn-lg btn-dark mt-2"><i class="uil uil-google-play"></i> پلی استور</a>
                            </div>
                            ...
                            <div class="d-inline-block">
                                <div class="pt-4 d-flex align-items-center border-top">
                                    ...
                                    <div class="content">
                                        <h6 class="mb-0">اکنون برنامه را روی تلفن های همراه خود نصب کنید</h6>
                                        <a href="javascript:void(0)" class="text-primary h6">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>  
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        ...
                        <p class="mt-4 text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                    ...
                    <div class="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        ...
                        <ul class="list-unstyled footer-list mt-4">
                            ...
                            <li><a href="page-team.html" class="text-muted"><i class="uil uil-angle-left-b me-1"></i> تیم </a></li>
                            <li><a href="page-pricing.html" class="text-muted"><i class="uil uil-angle-left-b me-1"></i> قیمت گذاری </a></li>
                            <li><a href="page-portfolio-modern.html" class="text-muted"><i class="uil uil-angle-left-b me-1"></i> پروژه </a></li>
                            <li><a href="page-jobs.html" class="text-muted"><i class="uil uil-angle-left-b me-1"></i> مشاغل </a></li>
                                ...
                                <div class="col-lg-12">
                                    <div class="foot-subscribe mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="email" name="email" id="emailsubscribe" class="form-control ps-5 rounded bg-light border text-muted" placeholder="ایمیل شما: " required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
