...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-260 w-100 d-table" data-jarallax='{"speed": 0.5}' style="background: url('images/event/event.jpg') center center;">
            <div class="bg-overlay bg-primary bg-gradient" style="opacity: 0.85;"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <div class="title-heading">
                            <h4 class="text-success mb-3">اردیبهشت 1400</h4>
                            <h1 class="display-4 title-dark text-white fw-bold mb-3">کنفرانس دیجیتال 01 - 1400</h1>
                            <p class="para-desc title-dark mx-auto text-light">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                            ...
                            <a href="javascript:void(0)" class="btn btn-success mt-2 me-2"><i class="uil uil-ticket"></i> خرید بلیط</a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        ...
        <div class="position-relative">
            <div class="shape overflow-hidden text-footer">
                <div class="text-center bg-white p-4">
                    <h5 class="text-dark mb-0">رویداد بعدی: 15 اردیبهشت ، 1400</h5>
                </div>
            </div>
        </div>
        <!-- Hero End -->
                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body section-title p-md-5">
                                <h4 class="title mb-4">کنفرانس راه اندازی کسب و کار</h4>
                                <p class="text-muted para-desc mb-0">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند. کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید مدیریت صفحه بوت استرپ v5 HTML با محوریت تبدیل.</p>
                                <div class="mt-4 pt-2">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary">ادامه مطلب  <i class="uil uil-angle-left-b"></i></a>
                                </div>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
        ...
        <section class="section bg-light">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">بلندگوهای ما</h4>
                        ...
                        <div class="card team text-center rounded border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3">
                                    ...
                                    <small class="designation text-muted">تنظیم کننده </small>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center rounded border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3">
                                    ...
                                    <small class="designation text-muted">مدیریت رویداد</small>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center rounded border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3">
                                    ...
                                    <small class="designation text-muted">محرک </small>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center rounded border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3">
                                    ...
                                    <small class="designation text-muted">اسپیکر </small>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-50">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">حامیان رویداد</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">برنامه های رویداد</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <ul class="date text-center text-primary me-3 mb-0 list-unstyled">
                                                        ...
                                                        <li class="month fw-bold">اردیبهشت </li>
                                                    </ul>
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">معرفی رویداد کنفرانس دیجیتال</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 3 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 10:30 قبل ظهر  تا  11:15 قبل ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card event-schedule rounded border">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">کنفرانس رابط کاربر</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 3 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 11:15 قبل ظهر تا  12:30 بعد ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card event-schedule rounded border">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">معرفی رویداد تجارت جهانی</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 3 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 11:15 قبل ظهر تا  12:30 بعد ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card event-schedule rounded border">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">کنفرانس تجاری برای حرفه ای ها</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 3 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 11:15 قبل ظهر تا  12:30 بعد ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card event-schedule rounded border">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">معرفی رویداد کنفرانس دیجیتال</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 4 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 10:30 قبل ظهر  تا  11:15 قبل ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card event-schedule rounded border">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1 content">
                                                        <h4><a href="javascript:void(0)" class="text-dark title">کنفرانس رابط کاربر</a></h4>
                                                        <p class="text-muted location-time"><span class="text-dark h6">آدرس:</span> سالن 4 ، سینچانگ دونگ ، گوانجو, <span class="text-danger">کره شمالی</span> <br> <span class="text-dark h6">تایم: </span> 11:15 قبل ظهر تا  12:30 بعد ظهر</p>
                                                        <a href="#tickets" class="btn btn-sm btn-outline-primary">خرید بلیط</a>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <!-- CTA Start -->
        <section class="section bg-cta" data-jarallax='{"speed": 0.5}' style="background: url('images/event/cta.jpg') center center;" id="cta">
            <div class="bg-overlay bg-primary bg-gradient" style="opacity: 0.85;"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title title-dark text-white mb-4">کنفرانس بین المللی دیجیتال 1400</h4>
                            <p class="text-light para-desc para-dark mx-auto">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
        ...
        <section class="section" id="tickets">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نرخ بلیط های ما</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    <div class="col-md-4 col-12 mt-4 pt-2">
                        <div class="card pricing-rates best-plan bg-light text-center border-0 rounded">
                            <div class="card-body py-5">
                                <img src="images/icon/ticket1.svg" class="mb-4" height="50" alt="">
                                <h6 class="title text-uppercase fw-bold mb-4">1 بلیط های روز</h6>
                                <div class="d-flex justify-content-center mb-4">
                                    <span class="price h1 mb-0"> 90 </span>
                                                <span class="h4 mb-0 mt-2"> هزار تومان </span>
                                                <span class="h4 align-self-end mb-1"> / روز  </span>
                                </div>

                                <p class="text-muted">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                                <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm mt-4">خرید بلیط</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-4 pt-2">
                        <div class="card pricing-rates best-plan text-center border-0 shadow rounded">
                            ...
                            <div class="card-body py-5">
                                <img src="images/icon/ticket2.svg" class="mb-4" height="50" alt="">
                                <h6 class="title text-uppercase fw-bold mb-4">بلیط کامل</h6>
                                <div class="d-flex justify-content-center mb-4">
                                    <span class="price h1 mb-0"> 24 </span>
                                                <span class="h4 mb-0 mt-2"> هزار تومان </span>
                                                <span class="h4 align-self-end mb-1"> / پر شده  </span>
                                </div>
                    ...
                    <div class="col-md-4 col-12 mt-4 pt-2">
                        <div class="card pricing-rates best-plan bg-light text-center border-0 rounded">
                            <div class="card-body py-5">
                                <img src="images/icon/ticket3.svg" class="mb-4" height="50" alt="">
                                <h6 class="title text-uppercase fw-bold mb-4">بلیط های زوج</h6>
                                <div class="d-flex justify-content-center mb-4">
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نظرات رویدادها</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
        ...
        <section class="section bg-light">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">رویداد ها و اخبار اخیر </h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">برای دریافت خبرنامه ما ثبت نام کنید</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold"> لنـدریـک  </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-10">
                        <div class="text-center subcribe-form mt-4 pt-2">
                            <form>
                                <input name="email" id="email" type="email" class="form-control rounded-pill" placeholder="ایمیل شما:" required aria-describedby="newssubscribebtn">
                                <button class="btn btn-pills btn-primary submitBnt" type="submit" id="newssubscribebtn">مشترک شدن </button>
                            </form><!--end form-->
                        </div>
                    </div>
                </div>
