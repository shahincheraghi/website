                    ...
                    <div class="col-lg-10">
                        <div class="title-heading text-center mt-4 mt-md-5 pt-md-5">
                            <div class="alert alert-light alert-pills" role="alert">
                                <span class="badge rounded-pill bg-success me-1">شروع </span>
                                <span class="content"> شغل را پر کنید <a href="page-job-apply.html" class="text-primary">اکنون </a>  اپلیکیشن را دانلود کن !</span>
                            </div>
                            <h1 class="heading mb-3">فرصت های شغلی برای <span class="text-primary typewrite" data-period="2000" data-type='[ "فریلنسری", "توسعه دهندگی", "طراح", "UX توسعه", "ios توسعه" ]'> <span class="wrap"></span> </span></h1>
                            <p class="para-desc mx-auto text-muted">جامعه عظیمی از طراحان و توسعه دهندگان آماده برای پروژه شما.</p>
                            <form class="rounded p-4 mt-4 bg-white">
                                <div class="row text-start">
                                    <div class="col-lg-5 col-md-4">
                                        <div class="mb-0">
                                            <input type="text" class="form-control" required placeholder="کلمات کلیدی">
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-7 col-md-8">
                                        <div class="row align-items-center">
                                            <div class="col-md-4 mt-4 mt-sm-0">
                                                <div class="mb-0">
                                                    <select class="form-control custom-select">
                                                        ...
                                                        <option value="AX">ایسلند</option>
                                                        <option value="AL">آلبانیا</option>
                                                        <option value="DZ">الجزیره </option>
                                                        <option value="AS">آمریکا</option>
                                                        <option value="AD">آندروا </option>
                                                        <option value="AO">آنگولا</option>
                                                        <option value="AI">آنگالیا </option>
                                                        <option value="AQ">کاستاریکا </option>
                                                    </select>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-4 mt-4 mt-sm-0">
                                                <div class="mb-0">
                                                    <select class="form-control custom-select">
                                                        <option selected="">نوع شغل</option>
                                                        <option value="4">حسابداری </option>
                                                        <option value="1">اطلاعات و نرم افزار</option>
                                                        <option value="3">بازاریابی </option>
                                                        <option value="5">بانکی </option>
                                                    </select>
                                                </div>
                                            </div><!--end col-->
                            ...
                            <p class="text-muted mb-0 mt-4"><span class="text-dark">کلمات کلیدی:</span> توسعه وب, طراحی وب, توسعه برنامه, طراحی وب, قالب ... </p>
                        </div>
                    </div><!--end col-->
        ...
        <section class="section">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">دسته بندی های محبوب</h4>
                ...
                <div class="row">
                        ...
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">ارتباطات </a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">حسابداری</a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">رستوران </a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">سلامت </a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">مالی</a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">امکانات</a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">مدیریت</a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="card categories overflow-hidden rounded shadow border-0">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled d-flex justify-content-between mb-0">
                                    <li><a href="javascript:void(0)" class="title h6 text-dark">ساخت و ساز </a></li>
                                    <li class="h6 mb-0 jobs">125 کار </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">مشاغل برجسته</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row">
                        ...
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">توسعه وب سینور</h4>
                                    <p class="text-muted mb-0">لندن </p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">توسعه بک اند</h4>
                                    <p class="text-muted mb-0">برزیل</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">توسعه دهنده بک اند</h4>
                                    <p class="text-muted mb-0">کانادا</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">UI طراح </h4>
                                    <p class="text-muted mb-0">چین</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">طراحان تجربه کاربری</h4>
                                    <p class="text-muted mb-0">کلمبیا</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">توسعه برنامه</h4>
                                    <p class="text-muted mb-0">کوبا</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">طراحی وب</h4>
                                    <p class="text-muted mb-0">قبرس</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">طراحی گرافیک </h4>
                                    <p class="text-muted mb-0">مصر</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">بررسی دیتا</h4>
                                    <p class="text-muted mb-0">فیجی</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">طراح اسکتچ </h4>
                                    <p class="text-muted mb-0">فنلاند</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <a href="page-job-detail.html">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">توسعه وب</h4>
                                    <p class="text-muted mb-0">آلمان</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-12 text-center mt-4 pt-2">
                        <a href="page-jobs.html" class="btn btn-primary">نمیاش همه مشاغل <i class="uil uil-angle-left-b align-middle"></i></a>
                    </div>
                </div><!--end row-->
            </div><!--end container-->
            <!-- Companies End -->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نامزدهای خبره</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                        ...
                        <div class="card team text-center border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3 pb-3">
                                    ...
                                    <small class="designation text-muted">توسعه وب</small>
                                    <h6 class="text-muted fw-normal">23000 تومان</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3 pb-3">
                                    ...
                                    <small class="designation text-muted">طراحی وب</small>
                                    <h6 class="text-muted fw-normal">12000 تومان</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3 pb-3">
                                    ...
                                    <small class="designation text-muted">IOS توسعه دهنده </small>
                                    <h6 class="text-muted fw-normal">29000 تومان</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card team text-center border-0">
                            <div class="card-body">
                                ...
                                <div class="content pt-3 pb-3">
                                    ...
                                    <small class="designation text-muted">Php توسعه دهنده </small>
                                    <h6 class="text-muted fw-normal">219000 تومان</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">بررسی نامزدها</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="foot-subscribe foot-white mb-3">
                                        <label class="text-muted form-label">ایمیل خود را بنویسید <span class="text-danger">*</span></label>
