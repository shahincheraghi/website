                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-lg-6 col-md-7">
                        <div class="title-heading">
                            <h1 class="heading mb-3">با استفاده از همه موارد خود را مدیریت کنید <span class="text-primary">لنـدریــک .</span> اپ سایت در دسترس است </h1>
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary mt-2 me-2"><i class="uil uil-apple"></i> اپ استور</a>
                                <a href="javascript:void(0)" class="btn btn-outline-primary mt-2"><i class="uil uil-google-play"></i> پلی استور</a>
                            </div>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">ویژگی های اپ</h4>
                        ...
                        <div class="row mt-4 pt-2">
                            <div class="col-md-6 col-12">
                                <div class="d-flex features pt-4 pb-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="title">در هر دستگاهی استفاده کنید</h4>
                                        <p class="text-muted para mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-flex features pt-4 pb-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="title">کد معتبر W3c</h4>
                                        <p class="text-muted para mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-flex features pt-4 pb-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="title">کاملا ریسپانسیو</h4>
                                        <p class="text-muted para mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-flex features pt-4 pb-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="title">سازگاری مرورگر</h4>
                                        <p class="text-muted para mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
        ...
        <section class="section pt-0 bg-light">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">چگونه ما میتوانیم به شما کمک کنیم ؟</h4>
                            <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 pt-2">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">بهترین  <span class="text-primary">لنـدریـک </span> با همکاری خوب برای شما</h4>
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4"><span class="text-primary">لنـدریـک </span> ویترین برنامه</h4>
                            <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                        ...
                        <ul class="nav nav-pills nav-justified flex-column flex-sm-row rounded" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link rounded" id="pills-apps-tab" data-bs-toggle="pill" href="#pills-apps" role="tab" aria-controls="pills-apps" aria-selected="false">
                                    <div class="text-center py-2">
                                        <h6 class="mb-0">24 / 7 پشتیبانی</h6>
                                    </div>
                                </a><!--end nav link-->
                            </li><!--end nav item-->
                        </ul><!--end nav pills-->
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <div class="section-title">
                                            <h4 class="title mb-4"><i class="uil uil-angle-double-right text-primary"></i> برنامه فرود با عملکرد بالا</h4>
                                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                                            <ul class="list-unstyled text-muted">
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                            ...
                            <div class="tab-pane fade" id="pills-smart" role="tabpanel" aria-labelledby="pills-smart-tab">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <div class="section-title">
                                            <h4 class="title mb-4"><i class="uil uil-angle-double-right text-primary"></i> طراحی خلاق و مدرن</h4>
                                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                                            <ul class="list-unstyled text-muted">
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                            ...
                            <div class="tab-pane fade" id="pills-apps" role="tabpanel" aria-labelledby="pills-apps-tab">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                        <div class="section-title">
                                            <h4 class="title mb-4"><i class="uil uil-angle-double-right text-primary"></i> 24/7 برنامه پشتیبانی و پاسخگو</h4>
                                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                                            <ul class="list-unstyled text-muted">
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">برنامه قیمت گذاری را انتخاب کنید</h4>
                            <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
        ...
        <section class="section pt-0">
            <div class="container">
                ...
                <div class="row mt-md-5 pt-md-3 mt-4 pt-2 mt-sm-0 pt-sm-0 justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">اکنون برنامه را دریافت کنید !</h4>
            ...
            <div class="container text-center">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <ul class="list-unstyled payment-cards text-sm-end mb-0">
