                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            <h4 class="title"> سلام ! <br> چگونه ما میتوانیم به شما کمک کنیم؟ </h4>

                            <div class="subcribe-form mt-4 pt-2">
                                <form>
                                    <div class="mb-0">
                                        <input type="text" id="help" name="name" class="border bg-white rounded-pill" required="" placeholder="سوالات خود را تایپ کنید...">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="mb-4">کمک لازم را پیدا کنید</h4>
                        ...
                        <div class="card explore-feature border-0 rounded text-center bg-white">
                            <div class="card-body">
                                ...
                                <div class="content mt-3">
                                    <a href="helpcenter-faqs.html" class="title h5 text-dark">نقل و قل</a>
                                    <p class="text-muted mt-3 mb-0">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل خواندن از اهمیت زیادی برخوردار است.</p>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card explore-feature border-0 rounded text-center bg-white">
                            <div class="card-body">
                                ...
                                <div class="content mt-3">
                                    <a href="helpcenter-guides.html" class="title h5 text-dark">راهنما / پشتیبانی</a>
                                    <p class="text-muted mt-3 mb-0">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل خواندن از اهمیت زیادی برخوردار است.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                        <div class="card explore-feature border-0 rounded text-center bg-white">
                            <div class="card-body">
                                ...
                                <div class="content mt-3">
                                    <a href="helpcenter-support-request.html" class="title h5 text-dark">درخواست پشتیبانی </a>
                                    <p class="text-muted mt-3 mb-0">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل خواندن از اهمیت زیادی برخوردار است.</p>
                                </div>
                            </div>
                        </div>
