...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-260 d-table w-100" style="background: url('images/job/candidate.jpg');">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="card job-profile shadow border-0">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">جزئیات شخصیs :</h5>
                                                                    
                                <ul class="list-unstyled">
                                    <li class="h6"><i data-feather="mail" class="fea icon-sm text-warning me-3"></i><span class="text-muted">ایمیل :</span> thomas@mail.com</li>
                                    <li class="h6"><i data-feather="gift" class="fea icon-sm text-warning me-3"></i><span class="text-muted">تاریخ تولد :</span> فروردین 1390</li>
                                    <li class="h6"><i data-feather="home" class="fea icon-sm text-warning me-3"></i><span class="text-muted">آدرس : </span> خیابان ریضایات</li>
                                    <li class="h6"><i data-feather="map-pin" class="fea icon-sm text-warning me-3"></i><span class="text-muted">شهر :</span> شاهین دژ </li>
                                    <li class="h6"><i data-feather="globe" class="fea icon-sm text-warning me-3"></i><span class="text-muted">کشور :</span> شاهین دژ </li>
                                    <li class="h6"><i data-feather="server" class="fea icon-sm text-warning me-3"></i><span class="text-muted">کد پستی  :</span> 521452</li>
                                    <li class="h6"><i data-feather="phone" class="fea icon-sm text-warning me-3"></i><span class="text-muted">موبایل : </span> (+125) 1542-8452</li>
                                ...
                                <div class="d-grid">
                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#Contactme" class="btn btn-primary"><i class="uil uil-envelope align-middle"></i> تماس با من</a>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-8 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="ms-lg-4">
                            <h4>درباره من  :</h4>
                            <p class="text-muted">بدیهی است که من توسعه وب دارم. توسعه وب با بیش از 3 سال تجربه. با تجربه تمام مراحل چرخه توسعه برای پروژه های وب پویا. در مقابل استفاده از "محتوا در اینجا ، محتوا در اینجا" ، باعث می شود که انگلیسی شبیه خواندن باشد.</p>
                            <p class="text-muted mb-0">ساختارهای داده و الگوریتم ها قلب برنامه نویسی هستند. در ابتدا بسیاری از توسعه دهندگان اهمیت آن را نمی دانند اما هنگامی که کار خود را در توسعه نرم افزار آغاز می کنید ، متوجه می شوید که کد شما زمان زیادی را می گیرد یا فضای زیادی را صرف می کند.</p>
                            
                            <!-- Skills Start -->
                            <h4 class="mt-lg-5 mt-4">مهارت ها:</h4>
                            ...
                            <!-- Experience Start -->
                            <h4 class="mt-lg-5 mt-4">تجربیات :</h4>
                            <div class="row">
                                <div class="col-lg-12 mt-4 pt-2">
                                    <div class="d-flex">
                                        <div class="company-logo text-muted h6 me-3 text-center">
                                            <img src="images/job/Codepen.svg" class="avatar avatar-md-sm mx-auto d-block mb-2" alt="">1397-98</div>
                                        <div class="flex-1">
                                            <h5 class="title mb-0">توسعه دهنده بک اند</h5>
                                            <small class="text-muted company-university">کدستر - هند</small>
                                            <p class="text-muted mt-2 mb-0">به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. می توان حدس زد که در طول زمان حروف خاصی به موقعیتهای مختلف متن اضافه یا حذف شده اند. </p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-lg-12 mt-4 pt-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <small class="text-muted company-university">CircleCi - ایران</small>
                                            <p class="text-muted mt-2 mb-0">به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. می توان حدس زد که در طول زمان حروف خاصی به موقعیتهای مختلف متن اضافه یا حذف شده اند. </p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                            ...
                            <!-- Start Projects Work -->
                            <h4 class="mt-lg-5 mt-4">پروژه ها  :</h4>
                            <div class="row">
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary me-2"><i class="uil uil-user-check"></i> من هستم</a>
                                <a href="javascript:void(0)" class="btn btn-outline-primary"><i class="uil uil-print"></i> چاپ رزومه </a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--enn row-->
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content rounded shadow border-0">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">تماس با من </h5>
