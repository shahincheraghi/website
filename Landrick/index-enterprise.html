                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title-heading text-center mt-4">
                            <h1 class="display-4 title-dark fw-bold text-white mb-3">شروع به راه قوی</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary"><i class="uil uil-envelope"></i> شروع کنید </a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title">
                            <h4 class="title mb-4">سرعت پیشرفت خود را افزایش دهید <br> همراه با <span class="text-primary">لنـدریــک .</span></h4>
                            ...
                            <a href="javascript:void(0)" class="mt-3 h6 text-primary">اطلاعات بیشتر <i class="uil uil-angle-left-b align-middle"></i></a>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-8 text-center">
                        <div class="tiny-single-item">
                            <div class="tiny-slide client-testi text-center">
                                ...
                                <p class="text-light para-dark h5 fw-normal fst-italic mt-4">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. "</p>
                                ...
                                <h6 class="text-light title-dark"> توماس لوری </h6>
                            </div>
                            
                            <div class="tiny-slide client-testi text-center">
                                <img src="images/client/02.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                <p class="text-light para-dark h5 fw-normal fst-italic mt-4">" مزیت ریشه لاتین آن و بی معنی بودن نسبی لورم ایپسوم این است که متن توجه را به خود جلب نمی کند یا توجه بیننده را از طرح منحرف نمی کند.. "</p>
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                ...
                                <h6 class="text-light title-dark"> کارلوس </h6>
                            </div>
                            
                            <div class="tiny-slide client-testi text-center">
                                <img src="images/client/03.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                <p class="text-light para-dark h5 fw-normal fst-italic mt-4">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است صرفاً برای پر کردن یک فضا. این گزینه ها برای متن های کلاسیک لورم اپیسوم اغلب سرگرم کننده هستند و داستان های کوتاه ، خنده دار یا مزخرفی را روایت می کنند. "</p>
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                ...
                                <h6 class="text-light title-dark"> باباکارما </h6>
                            </div>
                            
                            <div class="tiny-slide client-testi text-center">
                                <img src="images/client/04.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                <p class="text-light para-dark h5 fw-normal fst-italic mt-4">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است در سال 45 قبل از میلاد. گفته می شود ، یک محقق لاتین با جمع آوری تمام موارد کلمه غیرمعمول "لورم اپیسوم" که می توانست پیدا کند ، اصل متن را تأسیس کرد "</p>
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                ...
                                <h6 class="text-light title-dark"> چری استین  </h6>
                            </div>
                            ...
                            <div class="tiny-slide client-testi text-center">
                                ...
                                <h6 class="text-light title-dark"> دین لوس </h6>
                            </div>
                            
                            <div class="tiny-slide client-testi text-center">
                                <img src="images/client/06.jpg" class="img-fluid avatar avatar-small rounded-circle mx-auto shadow" alt="">
                                <p class="text-light para-dark h5 fw-normal fst-italic mt-4">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است. می توان حدس زد که در طول زمان حروف خاصی به موقعیتهای مختلف متن اضافه یا حذف شده اند. "</p>
                                <ul class="list-unstyled mb-0">
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                    <li class="list-inline-item"><i class="mdi mdi-star text-warning"></i></li>
                                ...
                                <h6 class="text-light title-dark"> جیل شبی </h6>
                            </div>
        ...
        <section class="section">
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">برنامه نمایشی را با ما برنامه ریزی کنید</h4>
                            <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-lg-7 col-md-10">
                        <div class="subcribe-form">
                            <form class="ms-0">
                                ...
                                <button type="submit" class="btn btn-pills btn-primary">ارسال  <i class="uil uil-angle-left-b align-middle"></i></button>
                            </form><!--end form-->
                        </div><!--end مشترک شدن فرم-->
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
