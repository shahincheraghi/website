...
<head>
    ...
    <body>
        ...
        <header id="topnav" class="defaultscroll sticky">
            <div class="container">
                ...
                <ul class="buy-button list-inline mb-0">
                    ...
                    <li class="list-inline-item mb-0">
                        <a href="#" class="btn btn-icon btn-primary"><i class="uil uil-facebook-f icons"></i></a>
                    </li>
                    <li class="list-inline-item mb-0">
                        <a href="#" class="btn btn-icon btn-primary"><i class="uil uil-github icons"></i></a>
                    </li>
                    <li class="list-inline-item mb-0">
                        <a href="#" class="btn btn-icon btn-primary"><i class="uil uil-twitter icons"></i></a>
                    </li>
                    <li class="list-inline-item mb-0">
                        <a href="#" class="btn btn-icon btn-primary"><i class="uil uil-linkedin-alt icons"></i></a>
                    </li>
                </ul><!--end login button-->
                <!-- End Logo container-->
        ...
        <!-- Hero Start -->
        <section class="bg-half-170 d-table w-100 it-home" style="background: url('images/it/bg1.jpg') center center;">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="title-heading">
                            <h6 class="text-white-50">نرم افزار و طراحی اطلاعات </h6>
                            <h1 class="fw-bold text-white title-dark mt-2 mb-3">نوآورانه پیشرفته <br> راه حل های اطلاعات.</h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary m-1"><i class="uil uil-phone"></i> در تماس باشید</a>
                    ...
                    <div class="col-lg-5 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="card shadow rounded border-0 ms-lg-5">
                            <div class="card-body">
                                <h5 class="card-title fw-bold">وقت ملاقات خود را ثبت کنید </h5>
                                <h6>ما در اینجا به شما کمک می کنیم 24/7 با متخصصان</h6>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative">
                                                    ...
                                                    <input type="number" name="number" class="form-control ps-5" placeholder="شماره تلفن " required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="d-flex features pt-4 pb-4">
                            ...
                            <div class="flex-1">
                                <h4 class="title">تجزیه و تحلیل داده</h4>
                                <p class="text-muted para mb-0">ساخته شده به زبان شبه لاتین که.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="d-flex features pt-4 pb-4">
                            ...
                            <div class="flex-1">
                                <h4 class="title">آی کیو و تست</h4>
                                <p class="text-muted para mb-0">ساخته شده به زبان شبه لاتین که.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-6 col-md-6 mt-4 mt-lg-0 pt- pt-lg-0">
                        <div class="ms-lg-4">
                            <div class="section-title">
                                <span class="badge bg-soft-primary rounded-pill fw-bold">درباره ما </span>
                                <h4 class="title mb-4 mt-3">راه حل های کسب و کار شما</h4>
                            ...
                            <div class="d-flex mt-4 pt-2">
                                ...
                                <div class="flex-1 ms-2">
                                    <h5>بحث گروهی جذاب​</h5>
                                    <p class="mb-0 text-muted">هنگامی که متن ساختگی نسبتاً واقع بینانه باشد ، به گونه ای سودمند خواهد بود که طرح بندی ایجاد شود</p>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">ما راه حل های فناوری اطلاعات و تجارت ارائه می دهیم</h4>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">تفکر نوآورانه</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">فن آوری </h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">توسعه نرم افزار</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">ایده تجاری</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">استراتژی محتوا</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">رابط بصری</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">مدیریت زمان</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">ثبت نام سریعتر</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded-pill shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title mb-0">فداکاری کار</h4>
                            </div>
                        </div>
                    </div><!--end col-->
                    
                    <div class="col-12 mt-4 pt-2 text-center">
                        <a href="javascript:void(0)" class="btn btn-primary">نمایش بیشتر <i class="uil uil-angle-left"></i></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="video-solution-cta position-relative" style="z-index: 1;">
                            <div class="position-relative py-5 rounded" style="background: url('images/it/cta.jpg') top;">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-6 my-4">
                                        <div class="counter-box text-center px-lg-4">
                                            ...
                                            <h1 class="mb-0 text-white"><span class="counter-value" data-target="9759">100</span>+</h1>
                                            <h6 class="counter-head text-white-50">مشتریان خوشحال </h6>
                                        </div><!--end counter box-->
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-3 col-6 my-4">
                                        <div class="counter-box text-center px-lg-4">
                                            ...
                                            <h1 class="mb-0 text-white"><span class="counter-value" data-target="15">1</span>+</h1>
                                            <h6 class="counter-head text-white-50">سال تجربه</h6>
                                        </div><!--end counter box-->
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-3 col-6 my-4">
                                        <div class="counter-box text-center px-lg-4">
                                            ...
                                            <h1 class="mb-0 text-white"><span class="counter-value" data-target="151">12</span>+</h1>
                                            <h6 class="counter-head text-white-50">پروژه های تکمیلی</h6>
                                        </div><!--end counter box-->
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-3 col-6 my-4">
                                        <div class="counter-box text-center px-lg-4">
                                            ...
                                            <h1 class="mb-0 text-white"><span class="counter-value" data-target="98">3</span>+</h1>
                                            <h6 class="counter-head text-white-50">مهندسین خبره</h6>
                                        </div><!--end counter box-->
                                    </div><!--end col-->
                                </div><!--end row-->
                            </div>
