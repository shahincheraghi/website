    ...
    <body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="title-heading mt-4">
                            <h1 class="heading mb-3">ساخت هرچیزی <br>برای پروژه شما</h1>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title me-lg-5">
                            <h4 class="title mb-4">درباره ایمیل مهم مطلع شوید</h4>
        ...
        <section class="section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <img src="images/illustrator/analyze_report_4.svg" class="me-md-4" alt="">
                    </div><!--end col-->

                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">کد تمیز و مدرن</h4>
                            <p class="text-muted">این مانع از تأثیرگذاری الگوهای تکراری در تصور بصری کلی می شود و مقایسه انواع مختلف را تسهیل می کند. بعلاوه ، وقتی متن ساختگی نسبتاً واقع بینانه باشد ، سودمند است.</p>
                            <a href="javascript:void(0)" class="btn btn-outline-primary">شروع کنید <i class="uil uil-angle-left-b"></i></a>
                        </div>
                    </div><!--end col-->
