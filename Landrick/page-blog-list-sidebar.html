                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            <h4 class="title"> لیست وبلاگ و نوار کناری </h4>
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">لیست وبلاگ با نوار کناری</li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                                    ...
                                    <div class="row align-items-center g-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body content">
                                                ...
                                                <p class="text-muted mb-0">به دلیل استفاده گسترده از آن به عنوان متن پر کننده برای طرح بندی, غیرقابل خواندن</p>
