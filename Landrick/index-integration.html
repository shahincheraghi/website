                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                        <div class="title-heading">
                            <span class="badge rounded-pill bg-success">ادغام </span>
                            <h4 class="heading text-white title-dark my-3">آینده نیز هست <br> <b>جالب هست</b> و بودن <b> قابل پیش بینی است</b>.</h4>
                            <p class="para-desc mx-auto text-white-50">در مورد همه چیز ، از یادگیری ماشین و پرداخت های جهانی گرفته تا مقیاس بندی تیم خود ، مقاله را کاوش و ادامه دهید.</p>
                        </div>

                        <div class="text-center subcribe-form mt-4 pt-2">
                            <form>
                                <input type="url" id="url" class="border bg-white rounded-lg" style="opacity: 0.85;" required placeholder="https://www.rtl-theme.com/author/tn_plugin/">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex features feature-clean core-feature rounded shadow p-4">
                                    ...
                                    <div class="flex-1 ms-4">
                                        <a href="javascript:void(0)" class="title text-dark h5">امنیت </a>
                                        <p class="text-muted mt-2 mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div class="d-flex features feature-clean core-feature rounded shadow p-4">
                                    ...
                                    <div class="flex-1 ms-4">
                                        <a href="javascript:void(0)" class="title text-dark h5">قابلیت اطمینان </a>
                                        <p class="text-muted mt-2 mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 mt-4 pt-2">
                                <div class="d-flex features feature-clean core-feature rounded shadow p-4">
                                    ...
                                    <div class="flex-1 ms-4">
                                        <a href="javascript:void(0)" class="title text-dark h5">انطباق </a>
                                        <p class="text-muted mt-2 mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                            ...
                            <div class="col-md-6 mt-4 pt-2">
                                <div class="d-flex features feature-clean core-feature rounded shadow p-4">
                                    ...
                                    <div class="flex-1 ms-4">
                                        <a href="javascript:void(0)" class="title text-dark h5">حریم خصوصی </a>
                                        <p class="text-muted mt-2 mb-0">ساخته شده در یک زبان شبه لاتین است که کم و بیش شبه لاتین مطابقت دارد.</p>
                                    </div>
                                </div>
                            </div><!--end col-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">با ابزارهای نظارت و هشدار ادغام شوید</h4>
                            
                            <h5><i class="uil uil-arrow-circle-right text-primary me-1"></i> نظارت بر ادغام ابزار</h5>
                            <p class="text-muted para-desc ms-4 ps-2">صفحه وضعیت را با دیتاداگ ، یادگار جدید ، لایبرتو یا پینگدوم تلفیق کنید تا صفحه شما به محض شناسایی مسئله به روز شود.</p>
                            <h5><i class="uil uil-arrow-circle-right text-primary me-1"></i> هشدار یکپارچه سازی ابزار</h5>
                            <p class="text-muted para-desc ms-4 ps-2">برای بروزرسانی مستقیم وضعیت از برنامه هشدار دهنده ، وضعیت وضعیت را با Opsgenie ، PagerDuty ، VictorOps یا مترس  تلفیق کنید.</p>
                            <h5><i class="uil uil-arrow-circle-right text-primary me-1"></i> اتوماسیون از طریق API یا ایمیل</h5>
                            <p class="text-muted para-desc ms-4 ps-2">از REST API ما برای به روزرسانی برنامه ای صفحه وضعیت خود با نوشتن یکپارچه سازی خود استفاده کنید ، یا به طور خودکار وضعیت اجزای سازنده را با ایجاد ایمیل با یک عنوان عنوان حاوی کلمات "UP" یا "DOWN" به روز کنید..</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                        ...
                        <a href="javascript:void(0)">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">کایرل </h4>
                                    <p class="text-muted mb-0">ادغام API</p>    
                                </div>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <a href="javascript:void(0)">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">کد پین </h4>
                                    <p class="text-muted mb-0">ادغام API</p>    
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <a href="javascript:void(0)">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">دور انداختن</h4>
                                    <p class="text-muted mb-0">ادغام API</p>    
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <a href="javascript:void(0)">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                ...
                                <div class="flex-1 ms-3">
                                    <h4 class="title mb-0 text-dark">اسلینت</h4>
                                    <p class="text-muted mb-0">ادغام API</p>    
                                </div>
                            </div>
                        </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title me-lg-5">
                            <h4 class="title mb-4">وب سایت های خود را تحویل دهید <br> سریع تر ، و بهتر.</h4>
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="section-title">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-1 ms-md-4 ms-3">
                                        <h4 class="fw-bold text-light title-dark mb-1">برنامه ما را بارگیری کنید!</h4>
                        ...
                        <div class="col-md-5 mt-4 mt-sm-0">
                            <div class="text-md-end ms-5 ms-sm-0">
                                <a href="javascript:void(0)" class="btn btn-primary me-2 me-lg-2 me-md-0 my-2"><i class="uil uil-apple"></i> اپ استور</a>
                                <a href="javascript:void(0)" class="btn btn-soft-primary my-2"><i class="uil uil-google-play"></i> پلی استور</a>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
                </div><!--end container-->
