                ...
                <div class="row align-items-center pt-5">
                    <div class="col-lg-7 col-md-6">
                        <div class="title-heading">
                            <h1 class="heading mb-3">همه چیز شما <br> نیاز به انجام <br> هر کاری با لندریک دارد. </h1>
                            ...
                            <div class="mt-4 pt-2">
                                <a href="https://www.rtl-theme.com/?p=133270" target="_blank" class="btn btn-primary">اکنون بخرید<span class="badge rounded-pill bg-danger ms-2">ورژن 3.1.1 </span></a>
                            </div>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 mt-4 pt-2 mt-lg-0 pt-lg-0">
                        <div class="section-title ms-lg-4">
                            <h1 class="title mb-3">سایت خود را از استفاده از این سایت بسازید </h1>
                            <p class="para-desc text-muted">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 order-2 order-lg-1 mt-4 pt-2 mt-lg-0 pt-lg-0">
                        <div class="section-title me-lg-4">
                            <h1 class="title mb-3">چرا ما را انتخاب کنید ؟</h1>
                            <p class="para-desc text-muted">کمپین خود را راه اندازی کنید و از تخصص ما در زمینه طراحی و مدیریت صفحه بوت استرپ v5 html تبدیل محور بهره مند شوید.</p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex align-items-center pt-4">
                                        ...
                                        <div class="ms-3">
                                            <h5>کاملاً امن </h5>
                                            <p class="text-muted mb-0">علاوه بر این ، در لاتین فقط کلمات در ابتدای جملات با حروف بزرگ هستند.</p>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                ...
                                <div class="col-12 pt-4">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary">اکنون نصب کن <i class="uil uil-angle-left-b"></i></a>
                                </div><!--end col-->
                            </div>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row justify-content-center" id="counter">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">به طور کلی <span class="text-primary"><span class="counter-value" data-target="333">1</span>هزار +</span> مشتری در حال استفاده است ، شروع کنید</h4>
                            <p class="text-muted para-desc mx-auto mb-0">با محبوب ترین کتابخانه مهای جلویی جهان ، پروژه های پاسخگو و همراه اول را در وب ایجاد کنید.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">نرخ قیمت های ما</h4>
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-8">
                            <div class="section-title text-md-start text-center">
                                <h4 class="title mb-3 text-white title-dark">امروز آزمایش 2 هفته رایگان خود را شروع کنید</h4>
                                <p class="text-white-50 mb-0">کار با لنـدریــک را شروع کنید که می تواند همه چیزهایی را که برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                            </div>
                        </div><!--end col-->
