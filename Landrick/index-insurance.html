                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12">
                        <div class="title-heading text-center">
                            <h1 class="heading title-dark text-white mb-3">بیمه لندریک</h1>
                                    ...
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">بیمه سلامت</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-2 col-md-4 col-6 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">بیمه عمر ترم</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-2 col-md-4 col-6 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">بیمه سلامت خانواده </a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-2 col-md-4 col-6 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">برنامه های سرمایه گذاری</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-2 col-md-4 col-6 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">4 بیمه ویلر</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-2 col-md-4 col-6 mt-4 pt-2">
                                    <div class="card explore-feature border-0 rounded text-center bg-white">
                                        <div class="card-body">
                                            ...
                                            <div class="content mt-3">
                                                <h6 class="mb-0"><a href="javascript:void(0)" class="title text-dark">2 بیمه ویلر</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end col-->
        ...
        <section class="section">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 pt-2">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">بیمه سلامت</h4>
                            ...
                            <div class="mt-4">
                                <a href="javascript:void(0)" class="btn btn-primary">ادامه مطلب  <i class="uil uil-angle-left-b align-middle"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 pt-2 order-2 order-md-1">
                        <div class="section-title me-lg-5">
                            <h4 class="title mb-4">برنامه های سرمایه گذاری</h4>
                            <p class="text-muted">شما می توانید تمام الگوهای لنـدریــک را در یک قالب واحد ترکیب کنید ، می توانید یک نظر را از موضوع برنامه بگیرید و از آن در وب سایت استفاده کنید.</p>
                            <ul class="list-unstyled text-muted">
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>راه حل های بازاریابی دیجیتال برای فردا</li>
                                <li class="mb-0"><span class="text-primary h5 me-2"><i class="uil uil-check-circle align-middle"></i></span>آژانس بازاریابی با استعداد و با تجربه ما</li>
                            ...
                            <div class="col-lg-6 col-md-7 col-12 offset-lg-6 offset-md-5">
                                <div class="card border-0">
                                    <div class="card-body p-md-5 p-4 bg-white rounded">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="title text-dark mb-0">حفاظت </h6>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6 col-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="title text-dark mb-0">مشتریان </h6>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6 col-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="title text-dark mb-0">صرفه جویی در نرخ</h6>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6 col-12 mt-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <h6 class="title text-dark mb-0">روند سریع</h6>
                                                    </div>
                                                </div>
                                            </div><!--end col-->
                                        </div><!--end row-->
                                        ...
                                        <div class="mt-4">
                                            <a href="javascript:void(0)" class="btn btn-primary">از زندگی خود محافظت کنید <i class="uil uil-angle-left-b align-middle"></i></a>
                                        </div>
                                    </div><!--end div-->
                                </div>
                            </div><!--end col-->
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">سایر طرح های بیمه</h4>
                ...
                <div class="row">
                    <a href="javascript:void(0)" class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">بیمه خانه</h4>
                            </div>
                        </div>
                    </a><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">مدیکرایم گروهی</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">برنامه های بازنشستگی</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">بیمه سفر</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">بیمه تاکسی</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">بیمه شرکت</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">بیمه سرطان</h4>
                            </div>
                        </a>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <a href="javascript:void(0)" class="d-flex key-feature align-items-center p-3 rounded shadow">
                            ...
                            <div class="flex-1">
                                <h4 class="title text-dark mb-0">برنامه های پس انداز کودک</h4>
                            </div>
                        </a>
                    </div><!--end col-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            <h4 class="title mb-4">مشتریان ما</h4>
                            <p class="text-muted para-desc mb-0 mx-auto">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container mt-100 mt-60">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="section-title">
                            <h4 class="title mb-4">ما اینجا هستیم تا به شما کمک کنیم</h4>
                            <p class="text-muted para-desc">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
                        ...
                        <div class="card rounded border-0 shadow-lg ms-lg-5">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <div class="section-title">
                                        <h6 class="my-3">کالوین لورس</h6>
                                        <p class="text-muted para-desc mx-auto mb-0">شروع به کار با <span class="text-primary fw-bold">لنـدریـک </span> که می تواند هر آنچه را که نیاز دارید فراهم کند.</p>
                                    </div>
                                </div>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mt-2">
                                                <div class="d-grid">
                                                    <button class="btn btn-soft-primary">درخواست تماس <i class="uil uil-angle-left-b align-middle"></i></button>
                                                </div>
                                            </div><!--end col-->
                                        </div>
                                    </form>                                    
                ...
                <div class="row mt-5 pt-md-4 justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            ...
                            <a href="page-contact-two.html" class="btn btn-primary mt-4"><i class="uil uil-phone"></i> تماس با ما</a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
