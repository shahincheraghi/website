                    ...
                    <div class="col-lg-12 text-center">
                        <div class="page-next-level">
                            ...
                            <ul class="list-unstyled mt-4">
                                <li class="list-inline-item h6 user text-muted me-2"> <span class="text-dark">مشتری: </span> کالوین لورس</li>
                                <li class="list-inline-item h6 date text-muted"> <span class="text-dark">تاریخ :</span> اردیبهشت 1400</li>
                            </ul>
                            <div class="page-next">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-10 mt-4 pt-2">
                        <div class="bg-light rounded p-4">
                            <p class="text-muted fst-italic mb-0">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است - لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.. "</p>
                        </div>
                        ...
                        <div class="bg-light rounded p-4 mt-4 pt-2">
                            <p class="text-muted fst-italic mb-0">" به نظر می رسد که تنها تکه هایی از متن اصلی در متن لورم اپیسوم که امروزه استفاده می شود باقی مانده است صرفاً برای پر کردن یک فضا. این گزینه ها برای متن های کلاسیک لورم اپیسوم اغلب سرگرم کننده هستند و داستان های کوتاه ، خنده دار یا مزخرفی را روایت می کنند. "</p>
                                ...
                                <div class="card work-details rounded bg-light border-0">
                                    <div class="card-body">
                                        ...
                                        <dl class="row mb-0">
                                            ...
                                            <dd class="col-md-8 col-7 text-muted">کالوین لورس</dd>

                                            <dt class="col-md-4 col-5">دستی :</dt>
                                            <dd class="col-md-8 col-7 text-muted">طراحی وب</dd>
                                            ...
                                            <dd class="col-md-8 col-7 text-muted">ایران، اورمیه، شاهین دژ</dd>
                                        </dl>  
                                    </div>                     
                                </div>
                            </div>
